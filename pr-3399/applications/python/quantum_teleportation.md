...
qubit, `state_of_q2`{.docutils .literal .notranslate}, is the same as
the random input state, [\\(\\ket{\\psi}\\)]{.math .notranslate
...
::: {.math .notranslate .nohighlight}
\\\[\\begin{split}\\begin{aligned} M1M2 = 00, \\ket{\\psi\_4} =
Z\^{0}X\^{0}\\ket{\\psi\_3(00)} = \\alpha\\ket{0} + \\beta\\ket{1} =
\\ket{\\psi} \\\\ M1M2 = 01, \\ket{\\psi\_4} =
Z\^{0}X\^{1}\\ket{\\psi\_3(01)} = \\alpha\\ket{0} + \\beta\\ket{1} =
\\ket{\\psi} \\\\ M1M2 = 10, \\ket{\\psi\_4} =
Z\^{1}X\^{0}\\ket{\\psi\_3(10)} = \\alpha\\ket{0} + \\beta\\ket{1} =
\\ket{\\psi} \\\\ M1M2 = 11, \\ket{\\psi\_4} =
Z\^{1}X\^{1}\\ket{\\psi\_3(11)} = \\alpha\\ket{0} + \\beta\\ket{1} =
