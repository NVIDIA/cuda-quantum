...
Previous](photonic.html "Photonic"){.btn .btn-neutral .float-left} [Next
...
.docutils .literal .notranslate} service. You can set it using an
...
.literal .notranslate} parameter when configuring the target. The
...
`cudaq.set_target()`{.docutils .literal .notranslate} function:
...
-   `url`{.docutils .literal .notranslate}: The URL of the Quantum
    Machines server

-   `executor`{.docutils .literal .notranslate}: The name of the
    executor/backend to use (defaults to "mock")

-   `api_key`{.docutils .literal .notranslate}: Your API key (optional
...
the flag `--target quantum_machines`{.docutils .literal .notranslate} to
...
-   `--quantum-machines-url`{.docutils .literal .notranslate}: The URL
    of the QOperator server

-   `--quantum-machines-executor`{.docutils .literal .notranslate}: The
    name of the executor/backend to use (defaults to "mock")

-   `--quantum-machines-api-key`{.docutils .literal .notranslate}: Your
