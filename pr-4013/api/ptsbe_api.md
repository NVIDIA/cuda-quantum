...
:   The choice of a specific Kraus operator at one noise site.
    ...
    [[is_error]{.pre}]{.sig-name .descname}*[[:]{.pre}]{.p}[ ]{.w}[[bool]{.pre}](https://docs.python.org/3/library/functions.html#bool "(in Python v3.14)"){.reference .external}*[¶](#cudaq.ptsbe.KrausSelection.is_error "Permalink to this definition"){.headerlink}
