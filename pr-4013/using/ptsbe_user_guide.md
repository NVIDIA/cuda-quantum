...
+=================+=====================================================+
| Probabilistic   | Performs a statistically unbiased Monte Carlo       |
| (default)       | sampling of trajectories producing a representative |
|                 | cross-section of the noise space.                   |
+-----------------+-----------------------------------------------------+
