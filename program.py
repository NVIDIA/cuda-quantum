...
# counts = cudaq.sample(test_loop_unroll)
# assert len(counts) == 1
# assert "111000" in counts
# print(counts)
# #print(test_loop_unroll)
# print(opt)

@cudaq.kernel
def test_loop_unroll_simple():
    qubits = cudaq.qvector(6)
    x(qubits[0])
...
counts = cudaq.sample(test_loop_unroll_simple)
assert len(counts) == 1
assert "111000" in counts
print(counts)
print(test_loop_unroll_simple)
