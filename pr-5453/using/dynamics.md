...
For C++, CUDA-Q provides the following integrators, to be used with the
[`dynamics`{.docutils .literal .notranslate}]{.pre} backend target.
...
| .docutils         | method). Good general-purpose choice.            |
| .literal          |                                                  |
| .no               |                                                  |
| translate}]{.pre} |                                                  |
+-------------------+--------------------------------------------------+
| [`cran            | Implicit predictor-corrector method. Well-suited |
| k_nicolson`{.code | for stiff systems or when energy conservation is |
| .docutils         | important. Configurable number of corrector      |
| .literal          | iterations.                                      |
| .no               |                                                  |
| translate}]{.pre} |                                                  |
+-------------------+--------------------------------------------------+
