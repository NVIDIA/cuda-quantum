...
-   [Backends](backends.html){.reference .internal}
    -   [Circuit Simulation](#){.current .reference .internal}
        ...
        -   [Photonics Simulators](sims/photonics.html){.reference
            ...
            -   [orca-photonics](sims/photonics.html#orca-photonics){.reference
                .internal}
    -   [Quantum Hardware (QPUs)](hardware.html){.reference .internal}
        -   [Ion Trap QPUs](hardware/iontrap.html){.reference .internal}
            -   [IonQ](hardware/iontrap.html#ionq){.reference .internal}
            -   [Quantinuum](hardware/iontrap.html#quantinuum){.reference
                .internal}
        -   [Superconducting
            QPUs](hardware/superconducting.html){.reference .internal}
        ...
        -   [Photonic QPUs](hardware/photonic.html){.reference
            ...
            -   [ORCA
                ...
                .internal}
        -   [Quantum Control Systems](hardware/qcontrol.html){.reference
            .internal}
            -   [Quantum
...
Previous](backends.html "CUDA-Q Backends"){.btn .btn-neutral .float-left
accesskey="p"} [Next []{.fa .fa-arrow-circle-right
aria-hidden="true"}](sims/svsims.html "State Vector Simulators"){.btn
...
::: {#cuda-q-circuit-simulation-backends .section}
# CUDA-Q Circuit Simulation Backends[¶](#cuda-q-circuit-simulation-backends "Permalink to this heading"){.headerlink}

The simulators available in CUDA-Q are grouped in the figure below. The
following sections follow the structure of the figure and provide
additional technical details and code examples for using each circuit
simulator.

<figure class="align-center">
<a href="../../_images/circuitsimulators.png"
class="reference internal image-reference"><img
src="../../_images/circuitsimulators.png" style="width: 900px;"
alt="../../_images/circuitsimulators.png" /></a>
</figure>

+-------------+-------------+-----------------+------+------+----------+
| Simulator   | Method      | Purpose         | Proc | Prec | N Qubits |
| Name        |             |                 | esso | isio |          |
|             |             |                 | r(s) | n(s) |          |
+=============+=============+=================+======+======+==========+
| [`qpp       | State       | Testing and     | CPU  | do   | \< 28    |
| -cpu`{.code | Vector      | small           |      | uble |          |
| .docutils   |             | applications    |      |      |          |
| .literal    |             |                 |      |      |          |
| .notransl   |             |                 |      |      |          |
| ate}]{.pre} |             |                 |      |      |          |
+-------------+-------------+-----------------+------+------+----------+
| [`nv        | State       | General purpose | Si   | si   | \< 33 /  |
| idia`{.code | Vector      | (default);      | ngle | ngle | 32 (64   |
| .docutils   |             | Trajectory      | GPU  | (    | GB)      |
| .literal    |             | simulation for  |      | defa |          |
| .notransl   |             | noisy circuits  |      | ult) |          |
| ate}]{.pre} |             |                 |      | /    |          |
| \*          |             |                 |      | do   |          |
|             |             |                 |      | uble |          |
+-------------+-------------+-----------------+------+------+----------+
| [`nvi       | State       | Large-scale     | m    | si   | 33+      |
| dia,`{.code | Vector      | simulation      | ulti | ngle |          |
| .docutils   |             |                 | -GPU | (    |          |
| .literal    |             |                 | mu   | defa |          |
| .notran     |             |                 | lti- | ult) |          |
| slate}]{.pr |             |                 | node | /    |          |
...
| .literal    |             | and high width  | mu   | defa |          |
| .notransl   |             | circuits        | lti- | ult) |          |
| ate}]{.pre} |             | (exact)         | node | /    |          |
| \*          |             |                 |      | si   |          |
|             |             |                 |      | ngle |          |
+-------------+-------------+-----------------+------+------+----------+
| [`tensornet | Matrix      | Square-shaped   | Si   | do   | Hundreds |
| -mps`{.code | Product     | circuits        | ngle | uble |          |
| .docutils   | State       | (approximate)   | GPU  | (    |          |
| .literal    |             |                 |      | defa |          |
| .notransl   |             |                 |      | ult) |          |
| ate}]{.pre} |             |                 |      | /    |          |
| \*          |             |                 |      | si   |          |
|             |             |                 |      | ngle |          |
+-------------+-------------+-----------------+------+------+----------+
| [`fermi     | Matrix      | Square-shaped   | Si   | do   | Hundreds |
| oniq`{.code | Product     | circuits        | ngle | uble |          |
| .docutils   | State       | (approximate)   | GPU  |      |          |
| .literal    |             |                 |      |      |          |
| .notransl   |             |                 |      |      |          |
| ate}]{.pre} |             |                 |      |      |          |
+-------------+-------------+-----------------+------+------+----------+
| [`nvi       | State       | Asynchronous    | m    | si   | \< 33 /  |
| dia,`{.code | Vector      | distribution    | ulti | ngle | 32 (64   |
| .docutils   |             | across multiple | -GPU | (    | GB)      |
| .literal    |             | simulated QPUs  | mu   | defa |          |
| .notran     |             | to speedup      | lti- | ult) |          |
| slate}]{.pr |             | applications    | node | /    |          |
| e}` `{.code |             |                 |      | do   |          |
| .docutils   |             |                 |      | uble |          |
| .literal    |             |                 |      |      |          |
| .notranslat |             |                 |      |      |          |
...
| \*          |             |                 |      |      |          |
+-------------+-------------+-----------------+------+------+----------+
| Trajectory  | works with  | Noisy           | m    | do   | varies   |
| Noisy       | all         | trajectory      | ulti | uble |          |
| Simulation  | simulators  | simulations     | -GPU |      |          |
|             | marked \*   |                 | mu   |      |          |
|             |             |                 | lti- |      |          |
|             |             |                 | node |      |          |
+-------------+-------------+-----------------+------+------+----------+
| [`den       | Density     | Noisy           | CPU  | do   | \< 14    |
| sity-matrix | Matrix      | simulations     |      | uble |          |
| -cpu`{.code |             |                 |      |      |          |
| .docutils   |             |                 |      |      |          |
| .literal    |             |                 |      |      |          |
| .notransl   |             |                 |      |      |          |
| ate}]{.pre} |             |                 |      |      |          |
+-------------+-------------+-----------------+------+------+----------+
| [`          | Stabilizer  | QEC simulation  | CPU  | N/A  | T        |
| stim`{.code |             |                 |      |      | housands |
| .docutils   |             |                 |      |      | +        |
| .literal    |             |                 |      |      |          |
| .notransl   |             |                 |      |      |          |
| ate}]{.pre} |             |                 |      |      |          |
+-------------+-------------+-----------------+------+------+----------+
| [           | State       | Photonics       | CPU  | do   | Varies   |
| `orca-photo | Vector      |                 |      | uble | on qudit |
| nics`{.code |             |                 |      |      | level    |
| .docutils   |             |                 |      |      |          |
| .literal    |             |                 |      |      |          |
| .notransl   |             |                 |      |      |          |
...
: [Simulators In
CUDA-Q]{.caption-text}[¶](#id1 "Permalink to this table"){.headerlink}

::: {.toctree-wrapper .compound}
-   [State Vector Simulators](sims/svsims.html){.reference .internal}
    -   [CPU](sims/svsims.html#cpu){.reference .internal}
    -   [Single-GPU](sims/svsims.html#single-gpu){.reference .internal}
    -   [Multi-GPU
        multi-node](sims/svsims.html#multi-gpu-multi-node){.reference
        .internal}
-   [Tensor Network Simulators](sims/tnsims.html){.reference .internal}
    -   [Multi-GPU
        multi-node](sims/tnsims.html#multi-gpu-multi-node){.reference
        .internal}
    -   [Matrix product
        state](sims/tnsims.html#matrix-product-state){.reference
        .internal}
    -   [Fermioniq](sims/tnsims.html#fermioniq){.reference .internal}
-   [Multi-QPU Simulators](sims/mqpusims.html){.reference .internal}
    -   [Simulate Multiple QPUs in
        Parallel](sims/mqpusims.html#simulate-multiple-qpus-in-parallel){.reference
        .internal}
    -   [Multi-QPU with Multi-Node Multi-GPU
...
-   [Noisy Simulators](sims/noisy.html){.reference .internal}
    -   [Trajectory Noisy
        Simulation](sims/noisy.html#trajectory-noisy-simulation){.reference
        .internal}
    -   [Density Matrix](sims/noisy.html#density-matrix){.reference
        .internal}
    -   [Stim](sims/noisy.html#stim){.reference .internal}
-   [Photonics Simulators](sims/photonics.html){.reference .internal}
    -   [orca-photonics](sims/photonics.html#orca-photonics){.reference
        .internal}
:::
:::
