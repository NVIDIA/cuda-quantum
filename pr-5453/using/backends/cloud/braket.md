...
[Amazon Braket](https://aws.amazon.com/braket/){.reference .external} is
a fully managed AWS service which provides Jupyter notebook
environments, high-performance quantum circuit simulators, and secure,
on-demand access to various quantum computers. To get started users must
enable Amazon Braket in their AWS account by following [these
instructions](https://docs.aws.amazon.com/braket/latest/developerguide/braket-enable-overview.html){.reference
.external}. To learn more about Amazon Braket, you can view the [Amazon
Braket Documentation](https://docs.aws.amazon.com/braket/){.reference
.external} and [Amazon Braket
Examples](https://github.com/amazon-braket/amazon-braket-examples/tree/main/examples/nvidia_cuda_q){.reference
.external}. A list of available devices and regions can be found
[here](https://docs.aws.amazon.com/braket/latest/developerguide/braket-devices.html){.reference
.external}.

Users can run CUDA-Q programs on Amazon Braket with [Hybrid
Job](https://docs.aws.amazon.com/braket/latest/developerguide/braket-what-is-hybrid-job.html){.reference
.external}. See [this
guide](https://docs.aws.amazon.com/braket/latest/developerguide/braket-jobs-first.html){.reference
.external} to get started with Hybrid Jobs and [this
guide](https://docs.aws.amazon.com/braket/latest/developerguide/braket-using-cuda-q.html){.reference
.external} on how to use CUDA-Q with Amazon Braket.

::: {#setting-credentials .section}
## Setting Credentials[¶](#setting-credentials "Permalink to this heading"){.headerlink}

After enabling Amazon Braket in AWS, set credentials using any of the
documented
...
By default, jobs are submitted to the state vector simulator,
[`SV1`{.code .docutils .literal .notranslate}]{.pre}.

To specify which Amazon Braket device to use, set the [`machine`{.code
...
can also set the [`emulate`{.docutils .literal .notranslate}]{.pre} flag
...
[`cudaq.sample`{.docutils .literal .notranslate}]{.pre}. By default, the
[`shots_count`{.docutils .literal .notranslate}]{.pre} is set to 1000.
