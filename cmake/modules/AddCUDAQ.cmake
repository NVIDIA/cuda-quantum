...
# Define `CUDAQ_MLIR_BUNDLED_LIBS_PATH`: the single list of libraries bundled into
# libcudaqMLIR. In-tree it lives in the source tree; installed it sits next to
# this file in lib/cmake/cudaq.
foreach(_candidate
...
# The complete set of libraries bundled into libcudaqMLIR.so.
...
function(add_cudaq_python_common_capi_library name)
  ...
  # 6. Header sources target + install (copied from add_mlir_python_common_capi_library)
