...
ADD "cudaq/include" /cuda-quantum/cudaq/include
ADD "cudaq/lib" /cuda-quantum/cudaq/lib
...
ADD "cudaq/test" /cuda-quantum/cudaq/test
ADD "cudaq/tools" /cuda-quantum/cudaq/tools
