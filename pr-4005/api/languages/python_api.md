...
:   The [`PyKernelDecorator`{.code .docutils .literal
    ...
    :   Return a string representation for this kernel, either as MLIR
        if available, or as the source code if not.

        To ensure an MLIR representation is returned, call
        [`compile`{.code .docutils .literal .notranslate}]{.pre}
        beforehand.
    ...
    *[static]{.pre}[ ]{.w}*[[from_json]{.pre}]{.sig-name .descname}[(]{.sig-paren}*[[jStr]{.pre}]{.n}*, *[[overrideDict]{.pre}]{.n}[[=]{.pre}]{.o}[[None]{.pre}]{.default_value}*[)]{.sig-paren}[¶](#cudaq.PyKernelDecorator.from_json "Permalink to this definition"){.headerlink}
    ...
    [[prepare_call]{.pre}]{.sig-name .descname}[(]{.sig-paren}*[[\*]{.pre}]{.o}[[args]{.pre}]{.n}*[)]{.sig-paren}[¶](#cudaq.PyKernelDecorator.prepare_call "Permalink to this definition"){.headerlink}

    :   Process call site arguments, capture lifted arguments and
        retrieve compiled module for kernel execution.

    [[process_call_arguments]{.pre}]{.sig-name .descname}[(]{.sig-paren}*[[\*]{.pre}]{.o}[[args]{.pre}]{.n}*[)]{.sig-paren}[¶](#cudaq.PyKernelDecorator.process_call_arguments "Permalink to this definition"){.headerlink}
