...
-   [Specifications](../index.html){.reference .internal}
    -   [Language Specification](../cudaq.html){.reference .internal}
        ...
        -   [2. Namespace and Standard](#){.current .reference
            .internal}
...
-   [2. ]{.section-number}Namespace and Standard
-   

::: {.rst-breadcrumbs-buttons role="navigation" aria-label="Sequential page navigation"}
[[]{.fa .fa-arrow-circle-left aria-hidden="true"}
Previous](machine_model.html "1. Machine Model"){.btn .btn-neutral
.float-left} [Next []{.fa .fa-arrow-circle-right
aria-hidden="true"}](types.html "3. Quantum Types"){.btn .btn-neutral
.float-right}
:::
...
::: {#namespace-and-standard .section}
[2. ]{.section-number}Namespace and Standard[¶](#namespace-and-standard "Permalink to this heading"){.headerlink}
=================================================================================================================

**\[1\]** The CUDA-Q language is a library-based extension for C++. As
such, all pertinent data structures and library functions exist within
the CUDA-Q namespace. This namespace is denoted `::cudaq`{.code
.docutils .literal .notranslate}.

**\[2\]** The `cudaq::contrib`{.code .docutils .literal .notranslate}
namespace contains features contributed by the larger community. While
these features provide useful functionality and are maintained across
releases, they may be more limited in functionality and may not cover
some scenarios. If you encounter issues or would like to request more
extensive features, please file a GitHub issue and we will consider them
for a future release.

**\[3\]** CUDA-Q is a C++ library-based language extension adherent to
the [C++20](https://en.cppreference.com/w/cpp/20){.reference .external}
language specification. Any implementations that require backwards
compatibility to previous standards must retain the semantics of the
user-facing API (e.g.
[SFINAE](https://en.cppreference.com/w/cpp/language/sfinae){.reference
.external} instead of [concepts and
constraints](https://en.cppreference.com/w/cpp/language/constraints){.reference
.external}).
:::
:::
:::
