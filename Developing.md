...
nvq++ "$CUDAQ_REPO_ROOT/docs/sphinx/examples/cpp/algorithms/grover.cq" -o grover.out && \
./grover.out
```
...
example](./docs/sphinx/examples/cpp/algorithms/grover.cq) are translated, you
can run

```bash
cudaq-quake $CUDAQ_REPO_ROOT/docs/sphinx/examples/cpp/algorithms/grover.cq
```
