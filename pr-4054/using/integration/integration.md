    ...
    -   [Data Center
        ...
        -   [Installation on the
            ...
            -   [MPI](../install/data_center_install.html#mpi){.reference
                .internal}
-   [Integration](#){.current .reference .internal}
...
Previous](../install/data_center_install.html "Installation from Source"){.btn
.btn-neutral .float-left accesskey="p"} [Next []{.fa
.fa-arrow-circle-right
aria-hidden="true"}](cmake_app.html "CUDA-Q and CMake"){.btn
...
::: {#integration-with-other-software-tools .section}
# Integration with other Software Tools[¶](#integration-with-other-software-tools "Permalink to this heading"){.headerlink}

::: {.toctree-wrapper .compound}
-   [Downstream CMake Integration](cmake_app.html){.reference .internal}
-   [Combining CUDA with CUDA-Q](cuda_gpu.html){.reference .internal}
-   [Integrating with Third-Party Libraries](libraries.html){.reference
    .internal}
:::

Information about customizing or extending the CUDA-Q toolchain can be
found in [[Extending
CUDA-Q]{.doc}](../extending/extending.html){.reference .internal}.
:::
:::
:::
