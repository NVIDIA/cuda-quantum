    ...
    -   [Language Specification](../cudaq.html){.reference .internal}
        ...
        -   [10. Quantum Patterns](patterns.html){.reference .internal}
            -   [10.1.
                ...
                .internal}
        -   [11. Platform](#){.current .reference .internal}
        -   [12. Algorithmic
...
-   [11. ]{.section-number}Quantum Platform
-   

::: {.rst-breadcrumbs-buttons role="navigation" aria-label="Sequential page navigation"}
[[]{.fa .fa-arrow-circle-left aria-hidden="true"}
Previous](patterns.html "10. Common Quantum Programming Patterns"){.btn
.btn-neutral .float-left} [Next []{.fa .fa-arrow-circle-right
aria-hidden="true"}](algorithmic_primitives.html "12. Quantum Algorithmic Primitives"){.btn
...
[11. ]{.section-number}Quantum Platform[¶](#quantum-platform "Permalink to this heading"){.headerlink}
======================================================================================================
...
.literal .notranslate} in an effort to expose relevant system
information and enable asynchronous quantum kernel invocations.

**\[3\]** The `cudaq::quantum_platform`{.code .docutils .literal
.notranslate} provides an API for querying the number of available
quantum processing units (QPUs), with each QPU assigned a logical
integer index (`{0,1,2,...}`{.code .docutils .literal .notranslate}).

**\[4\]** Programmers can specify the ID of the desired QPU and all
subsequent CUDA-Q kernel executions will target that QPU.

The `cudaq::quantum_platform`{.code .docutils .literal .notranslate}
...
CUDA-Q provides the following public functions to interact with the
current `cudaq::quantum_platform`{.code .docutils .literal .notranslate}
