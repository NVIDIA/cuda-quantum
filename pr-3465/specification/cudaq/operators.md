    ...
    -   [Language Specification](../cudaq.html){.reference .internal}
        ...
        -   [3. Quantum Types](types.html){.reference .internal}
            ...
            -   [3.3. Quantum
                ...
                .internal}
        -   [4. Quantum Operators](#){.current .reference .internal}
            -   [4.1. `cudaq::spin_op`{.code .docutils .literal
                .notranslate}](#cudaq-spin-op){.reference .internal}
...
-   [4. ]{.section-number}Quantum Operators
-   

::: {.rst-breadcrumbs-buttons role="navigation" aria-label="Sequential page navigation"}
[[]{.fa .fa-arrow-circle-left aria-hidden="true"}
Previous](types.html "3. Quantum Types"){.btn .btn-neutral .float-left}
[Next []{.fa .fa-arrow-circle-right
aria-hidden="true"}](operations.html "5. Quantum Intrinsic Operations"){.btn
...
::: {#quantum-operators .section}
[4. ]{.section-number}Quantum Operators[¶](#quantum-operators "Permalink to this heading"){.headerlink}
=======================================================================================================

::: {#cudaq-spin-op .section}
[4.1. ]{.section-number}`cudaq::spin_op`{.code .docutils .literal .notranslate}[¶](#cudaq-spin-op "Permalink to this heading"){.headerlink}
-------------------------------------------------------------------------------------------------------------------------------------------

**\[1\]** CUDA-Q provides a native `spin_op`{.code .docutils .literal
.notranslate} data type in the `cudaq`{.code .docutils .literal
.notranslate} namespace for the expression of quantum mechanical spin
operators.

**\[2\]** The `spin_op`{.code .docutils .literal .notranslate} provides
an abstraction for a general tensor product of Pauli spin operators, and
sums thereof:

::: {.math .notranslate .nohighlight}
\\\[H = \\sum\_{i=0}\^M P\_i, P\_i = \\prod\_{j=0}\^N \\sigma\_j\^a\\\]
:::

for [\\(a = {x,y,z}\\)]{.math .notranslate .nohighlight},
[\\(j\\)]{.math .notranslate .nohighlight} the qubit index, and
[\\(N\\)]{.math .notranslate .nohighlight} the number of qubits.

**\[3\]** The `spin_op`{.code .docutils .literal .notranslate} exposes
common C++ operator overloads for algebraic expressions.

**\[4\]** CUDA-Q defines static functions to create the primitive X, Y,
and Z Pauli operators on specified qubit indices which can subsequently
be used in algebraic expressions to build up more complicated Pauli
tensor products and their sums.
...
**\[5\]** The `spin_op`{.code .docutils .literal .notranslate} also
provides a mechanism for the expression of circuit synthesis tasks
within quantum kernel code. Specifically, operations that encode
[\\(N\\)]{.math .notranslate .nohighlight}^th^order trotterization of
exponentiated `spin_op`{.code .docutils .literal .notranslate}
rotations, e.g. [\\(U = \\exp(-i H t)\\)]{.math .notranslate
.nohighlight}, where [\\(H\\)]{.math .notranslate .nohighlight} is the
provided `spin_op`{.code .docutils .literal .notranslate}. Currently, H
is limited to a single product term.

**\[6\]** The `spin_op`{.code .docutils .literal .notranslate} can be
created within classical host code and quantum kernel code, and can also
be passed by value to quantum kernel code from host code.
:::
:::
:::
:::
