...
.notranslate}]{.pre} provides an API for querying the number of
available quantum processing units (QPUs), with each QPU assigned a
...
current [`cudaq::quantum_platform`{.code .docutils .literal
.notranslate}]{.pre}
