...
To see a complete example of using TII's backends, please take a look at
the [[TII examples]{.std
.std-ref}](../../examples/hardware_providers.html#tii-examples){.reference
.internal}.
