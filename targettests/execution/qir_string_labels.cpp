...
// CHECK:       attributes #[[ATTR_1]] = { "entry_point" "output_labeling_schema"="schema_id" "output_names"="{{\[}}{{\[}}0,[0,\22measureResult\22]]]" "qir_profiles"="{{.*}}_profile" "requiredQubits"="1" "requiredResults"="1" }
