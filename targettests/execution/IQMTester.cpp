...
// the mock server has Crystal 20 architecture
...
CUDAQ_TEST(IQMTester, architectureMismatched) {
  EXPECT_THAT(
      ...
      testing::ThrowsMessage<std::runtime_error>(
          testing::StrEq("IQM QPU architecture mismatch: Expecting Crystal 5.")));
}
