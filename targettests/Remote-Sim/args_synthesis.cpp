...
// FIXME: https://github.com/NVIDIA/cuda-quantum/issues/1383
// DEFINE_TEST_KERNEL(test3_7, (char, a, CHAR_VAL) (std::vector<bool>, b,
// VEC_BOOL_VAL)) DEFINE_TEST_KERNEL(test3_8, (char, a, CHAR_VAL)
// (std::vector<char>, b, VEC_CHAR_VAL))
...
// FIXME: https://github.com/NVIDIA/cuda-quantum/issues/1383
// DEFINE_TEST_KERNEL(test4_7, (int, a, INT_VAL) (std::vector<bool>, b,
// VEC_BOOL_VAL)) DEFINE_TEST_KERNEL(test4_8, (int, a, INT_VAL)
// (std::vector<char>, b, VEC_CHAR_VAL))
DEFINE_TEST_KERNEL(test4_9, (int, a, INT_VAL)(std::vector<int>, b, VEC_INT_VAL))
...
DEFINE_TEST_KERNEL(test5_4, (std::size_t, a, SIZE_T_VAL)(int64_t, b, INT64_VAL))
DEFINE_TEST_KERNEL(test5_5, (std::size_t, a, SIZE_T_VAL)(double, b, DOUBLE_VAL))
...
// b, VEC_BOOL_VAL)) DEFINE_TEST_KERNEL(test5_8, (std::size_t, a, SIZE_T_VAL)
// (std::vector<char>, b, VEC_CHAR_VAL))
...
DEFINE_TEST_KERNEL(test6_3, (double, a, DOUBLE_VAL)(std::size_t, b, SIZE_T_VAL))
...
// FIXME: https://github.com/NVIDIA/cuda-quantum/issues/1383
// DEFINE_TEST_KERNEL(test6_7, (double, a, DOUBLE_VAL) (std::vector<bool>, b,
// VEC_BOOL_VAL)) DEFINE_TEST_KERNEL(test6_8, (double, a, DOUBLE_VAL)
// (std::vector<char>, b, VEC_CHAR_VAL))
...
// FIXME: https://github.com/NVIDIA/cuda-quantum/issues/1383
// DEFINE_TEST_KERNEL(test7_7, (float, a, FLOAT_VAL) (std::vector<bool>, b,
// VEC_BOOL_VAL)) DEFINE_TEST_KERNEL(test7_8, (float, a, FLOAT_VAL)
// (std::vector<char>, b, VEC_CHAR_VAL))
...
// DEFINE_TEST_KERNEL(test8_1, (std::vector<char>, a, VEC_CHAR_VAL) (char, b,
// CHAR_VAL)) DEFINE_TEST_KERNEL(test8_2, (std::vector<char>, a, VEC_CHAR_VAL)
// (int, b, INT_VAL)) DEFINE_TEST_KERNEL(test8_3, (std::vector<char>, a,
// VEC_CHAR_VAL) (std::size_t, b, SIZE_T_VAL)) DEFINE_TEST_KERNEL(test8_4,
// (std::vector<char>, a, VEC_CHAR_VAL) (int64_t, b, INT64_VAL))
// DEFINE_TEST_KERNEL(test8_5, (std::vector<char>, a, VEC_CHAR_VAL) (double, b,
// DOUBLE_VAL)) DEFINE_TEST_KERNEL(test8_6, (std::vector<char>, a, VEC_CHAR_VAL)
// (float, b, FLOAT_VAL)) DEFINE_TEST_KERNEL(test8_7, (std::vector<char>, a,
// VEC_CHAR_VAL) (std::vector<bool>, b, VEC_BOOL_VAL))
// DEFINE_TEST_KERNEL(test8_8, (std::vector<char>, a, VEC_CHAR_VAL)
// (std::vector<char>, b, VEC_CHAR_VAL)) DEFINE_TEST_KERNEL(test8_9,
// (std::vector<char>, a, VEC_CHAR_VAL) (std::vector<int>, b, VEC_INT_VAL))
// DEFINE_TEST_KERNEL(test8_10, (std::vector<char>, a, VEC_CHAR_VAL)
// (std::vector<std::size_t>, b, VEC_SIZE_T_VAL)) DEFINE_TEST_KERNEL(test8_11,
// (std::vector<char>, a, VEC_CHAR_VAL) (std::vector<double>, b,
// VEC_DOUBLE_VAL)) DEFINE_TEST_KERNEL(test8_12, (std::vector<char>, a,
// VEC_CHAR_VAL) (std::vector<float>, b, VEC_FLOAT_VAL))

DEFINE_TEST_KERNEL(test9_1,
                   (std::vector<int>, a, VEC_INT_VAL)(char, b, CHAR_VAL))
DEFINE_TEST_KERNEL(test9_2, (std::vector<int>, a, VEC_INT_VAL)(int, b, INT_VAL))
...
// FIXME: https://github.com/NVIDIA/cuda-quantum/issues/1383
// DEFINE_TEST_KERNEL(test9_7, (std::vector<int>, a, VEC_INT_VAL)
// (std::vector<bool>, b, VEC_BOOL_VAL)) DEFINE_TEST_KERNEL(test9_8,
// (std::vector<int>, a, VEC_INT_VAL) (std::vector<char>, b, VEC_CHAR_VAL))
...
// FIXME: https://github.com/NVIDIA/cuda-quantum/issues/1383
// DEFINE_TEST_KERNEL(test10_7, (std::vector<std::size_t>, a, VEC_SIZE_T_VAL)
// (std::vector<bool>, b, VEC_BOOL_VAL)) DEFINE_TEST_KERNEL(test10_8,
// (std::vector<std::size_t>, a, VEC_SIZE_T_VAL) (std::vector<char>, b,
// VEC_CHAR_VAL))
DEFINE_TEST_KERNEL(test10_9, (std::vector<std::size_t>, a,
...
// FIXME: https://github.com/NVIDIA/cuda-quantum/issues/1383
// DEFINE_TEST_KERNEL(test11_7, (std::vector<double>, a, VEC_DOUBLE_VAL)
// (std::vector<bool>, b, VEC_BOOL_VAL)) DEFINE_TEST_KERNEL(test11_8,
// (std::vector<double>, a, VEC_DOUBLE_VAL) (std::vector<char>, b,
// VEC_CHAR_VAL))
DEFINE_TEST_KERNEL(test11_9, (std::vector<double>, a,
                              VEC_DOUBLE_VAL)(std::vector<int>, b, VEC_INT_VAL))
...
DEFINE_TEST_KERNEL(test12_4, (std::vector<float>, a, VEC_FLOAT_VAL)(int64_t, b,
                                                                    INT64_VAL))
DEFINE_TEST_KERNEL(test12_5, (std::vector<float>, a, VEC_FLOAT_VAL)(double, b,
                                                                    DOUBLE_VAL))
DEFINE_TEST_KERNEL(test12_6,
                   (std::vector<float>, a, VEC_FLOAT_VAL)(float, b, FLOAT_VAL))
// FIXME: https://github.com/NVIDIA/cuda-quantum/issues/1383
// DEFINE_TEST_KERNEL(test12_7, (std::vector<float>, a, VEC_FLOAT_VAL)
// (std::vector<bool>, b, VEC_BOOL_VAL)) DEFINE_TEST_KERNEL(test12_8,
// (std::vector<float>, a, VEC_FLOAT_VAL) (std::vector<char>, b, VEC_CHAR_VAL))
DEFINE_TEST_KERNEL(test12_9, (std::vector<float>, a,
                              VEC_FLOAT_VAL)(std::vector<int>, b, VEC_INT_VAL))
DEFINE_TEST_KERNEL(test12_10,
                   (std::vector<float>, a,
                    VEC_FLOAT_VAL)(std::vector<std::size_t>, b, VEC_SIZE_T_VAL))
...
DEFINE_TEST_KERNEL(test_mixed_6,
                   (std::size_t, a, SIZE_T_VAL)(int, b, INT_VAL)(std::size_t, c,
                                                                 SIZE_T_VAL))
// FIXME: vector<char> is not supported in synthesis
// DEFINE_TEST_KERNEL(test_mixed_7, (int, a, INT_VAL) (std::vector<char>, b,
// VEC_CHAR_VAL) (std::vector<float>, c, VEC_FLOAT_VAL))
// DEFINE_TEST_KERNEL(test_mixed_8, (int, a, INT_VAL) (std::vector<char>, b,
// VEC_CHAR_VAL) (std::vector<double>, c, VEC_DOUBLE_VAL))
// DEFINE_TEST_KERNEL(test_mixed_9, (std::size_t, a, SIZE_T_VAL)
// (std::vector<double>, b, VEC_DOUBLE_VAL) (std::vector<char>, c,
// VEC_CHAR_VAL)) DEFINE_TEST_KERNEL(test_mixed_10, (std::size_t, a, SIZE_T_VAL)
// (std::vector<float>, b, VEC_FLOAT_VAL) (std::vector<char>, c, VEC_CHAR_VAL))
// DEFINE_TEST_KERNEL(test_mixed_11, (double, a, DOUBLE_VAL) (std::vector<char>,
// b, VEC_CHAR_VAL) (std::vector<float>, c, VEC_FLOAT_VAL))
// DEFINE_TEST_KERNEL(test_mixed_12, (double, a, DOUBLE_VAL) (std::vector<char>,
// b, VEC_CHAR_VAL) (std::vector<double>, c, VEC_DOUBLE_VAL))
// DEFINE_TEST_KERNEL(test_mixed_13, (float, a, FLOAT_VAL) (std::vector<double>,
// b, VEC_DOUBLE_VAL) (std::vector<char>, c, VEC_CHAR_VAL))
// DEFINE_TEST_KERNEL(test_mixed_14, (float, a, FLOAT_VAL) (std::vector<float>,
// b, VEC_FLOAT_VAL) (std::vector<char>, c, VEC_CHAR_VAL))
