...
aria-hidden="true"}](../../using/examples/ptsbe.html "Pre-Trajectory Sampling with Batch Execution (PTSBE)"){.btn
...
Kraus operators, [\\(\\{ K_i \\}\\)]{.math .notranslate .nohighlight},
which satisfy the condition [\\(\\sum\_{i} K_i\^\\dagger K_i =
...
\\\[\\begin{split}K_0 = \\sqrt{1-p} \\begin{pmatrix} 1 & 0 \\\\ 0 & 1
\\end{pmatrix}\\end{split}\\\]
:::

::: {.math .notranslate .nohighlight}
\\\[\\begin{split}K_1 = \\sqrt{p} \\begin{pmatrix} 0 & 1 \\\\ 1 & 0
\\end{pmatrix}\\end{split}\\\]
:::
...
[`cudaq.apply_noise`{.docutils .literal .notranslate}]{.pre} function.
You can place this method in your kernels, and inject specific noise on
specific qubits wherever you need.
