...
bool RequestValidator::validateRequest(const SerializedCodeExecutionContext &serializedCodeExecutionContext,
    ...
    try {
        ...
        if (!validateNamespace(localsNamespace) || !validateNamespace(globalsNamespace)) {
