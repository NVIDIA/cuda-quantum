...
const std::string &matrix_operator::unique_id() const { return this->id; }
...
matrix_operator::matrix_operator(const T &other) {
  ...
  this->op_code = type_prefix + other.to_string(false) +
