...
struct PTSBEResult {
    ...
    /// Each GateApplicationTask is either a gate or a deterministic noise operation (Kraus op)
    /// Task lists contain only unitary operations - noise channels are pre-sampled
