...
struct QDMIPlatformDevice {
  ...
  std::optional<fomac::CustomJobParameter> jobCustom1;
  std::optional<fomac::CustomJobParameter> jobCustom2;
  std::optional<fomac::CustomJobParameter> jobCustom3;
  std::optional<fomac::CustomJobParameter> jobCustom4;
  std::optional<fomac::CustomJobParameter> jobCustom5;
  std::string name;
