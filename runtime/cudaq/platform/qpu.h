...
protected:
  ...
  void handleObservation(ExecutionContext &context) {
...
public:
  ...
  virtual void configureExecutionContext(ExecutionContext &context) {}

  /// @brief Post-process the execution results stored in @p context for this
  /// QPU.
  virtual void processExecutionResults(ExecutionContext &context) {}
