...
#include "DefaultQPU.h"
  ...
  cudaq::details::DefaultQPU::launchKernel(const std::string &name, cudaq::KernelThunkType kernelFunc,
  ...
  void
  cudaq::details::DefaultQPU::configureExecutionContext(cudaq::ExecutionContext &context) const {
  ...
  void
  cudaq::details::DefaultQPU::finalizeExecutionContext(cudaq::ExecutionContext &context) const {
