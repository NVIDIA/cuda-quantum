...
public:
  ...
  /// @brief Return the `EigenMatrix` representation of this matrix. The
  /// `EigenMatrix` matrix is a thin wrapper around the internal data. If the
  /// data ever becomes invalidated, this return value will become invalid.
