...
public:
  ...
  /// Copy a borrowed cuStateVec state into a same-precision host buffer.
  /// Distributed states may request either rank-local or global amplitudes.
  static void copyStateToHost(CuStateVecState<Scalar> &state,
