...
public:
  ...
  std::complex<double> overlap(const cudaq::SimulationState &other) override {
    ...
    if (isDevicePointer(other.getTensor().data)) {
      ...
      auto thrustCmplx = nvqir::innerProduct<ScalarType>(devicePtr, other.getTensor().data, size, false);
      ...
      auto thrustCmplx = nvqir::innerProduct<ScalarType>(devicePtr, other.getTensor().data, size, true);
      return {thrustCmplx.real(), thrustCmplx.imag()};
    }
  }
