...
//                                "dimension not equal to this state
//                                dimension.");
...
//       throw std::runtime_error(
//           "[qpp-state] overlap with pointer data, invalid number of
//           elements.");

//     return std::abs(
//         state.transpose()
//             .dot(Eigen::Map<qpp::ket>(reinterpret_cast<cudaq::complex
//             *>(data),
//                                       getDataShape()[0]))
//             .real());
//   }
...
//     return reinterpret_cast<void *>(const_cast<cudaq::complex
//     *>(state.data()));
//   }
...
public:
  ...
  std::unique_ptr<cudaq::SimulationState> getSimulationState() override {
    flushGateQueue();
    return std::make_unique<cudaq::QppState>(std::move(state));
  }
