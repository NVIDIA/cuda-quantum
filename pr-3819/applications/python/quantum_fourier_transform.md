...
-   [Applications](../../using/applications.html){.reference .internal}
    ...
    -   [Spin-Hamiltonian Simulation Using
        ...
        -   [Relevant
            ...
            .internal}
    -   [Quantum Fourier Transform](#){.current .reference .internal}
        -   [Quantum Fourier Transform
            revisited](#Quantum-Fourier-Transform-revisited){.reference
            .internal}
...
Previous](hamiltonian_simulation.html "Spin-Hamiltonian Simulation Using CUDA-Q"){.btn
.btn-neutral .float-left accesskey="p"} [Next []{.fa
.fa-arrow-circle-right
aria-hidden="true"}](quantum_teleportation.html "Quantum Teleporation"){.btn
...
Classical Fourier transforms aid many areas such as signal processing
and data compression. Below, we quantize it to enable Quantum Fourier
Transforms (QFT) in CUDA-Q.

QFT is a key ingredient in Shor's algorithm which is exponentially
faster at factoring prime numbers and also plays a vital role in many
other interesting quantum algorithms.

The idea with classical Fourier transforms is to take the problem from
the frequency domain, to the time domain where it is easier to solve.
This is the same analogy we draw with QFT, where we take the basis state
from the computational basis to the Fourier basis.

The Quantum Fourier Transform is defined to be the linear operation
which takes a basis state, [\\(\\ket{x}\\)]{.math .notranslate
.nohighlight},

::: {.math .notranslate .nohighlight}
\\\[\\begin{equation} \\text{QFT}\\ket{x} =
\\frac{1}{\\sqrt{N}}\\sum\_{y=0}\^{N-1} e\^{\\frac{2\\pi ixy}{N}}
\\ket{y} \\tag{1} \\end{equation}\\\]
:::

where [\\(n\\)]{.math .notranslate .nohighlight} is the number of qubits
and [\\(N= 2\^n\\)]{.math .notranslate .nohighlight}.

It is convenient to represent states like [\\(\\ket{x} =
\\ket{101}\\)]{.math .notranslate .nohighlight} in their binary
representation which in this case would be [\\(2\^2 \\times 1 + 2\^1
\\times 0 + 2\^0 \\times 1 = \\ket{5}\\)]{.math .notranslate
.nohighlight}.

For the [\\(n=1\\)]{.math .notranslate .nohighlight} qubit case, we have
the following basis states: [\\(\\ket{0}, \\ket{1}\\)]{.math
.notranslate .nohighlight}. The QFT on these is as follows:

::: {.math .notranslate .nohighlight}
\\\[\\begin{split}\\begin{equation} \\begin{aligned}
\\text{QFT}\|0\\rangle &= \\frac{1}{\\sqrt{2}}\\sum\_{y=0}\^{2-1}
e\^{\\frac{2\\pi i(0)y}{2}}\|y\\rangle \\\\ &=
\\frac{1}{\\sqrt{2}}\\left(e\^0\|0\\rangle + e\^0\|1\\rangle\\right)
\\\\ &= \\frac{1}{\\sqrt{2}}(\|0\\rangle + \|1\\rangle) \\\\ &= \\ket{+}
\\\\ \\end{aligned} \\tag{2} \\end{equation}\\end{split}\\\]
:::

::: {.math .notranslate .nohighlight}
\\\[\\begin{split}\\begin{equation} \\begin{aligned}
\\text{QFT}\|1\\rangle &= \\frac{1}{\\sqrt{2}}\\sum\_{y=0}\^{2-1}
e\^{\\frac{2\\pi i(1)y}{2}}\|y\\rangle \\\\ &=
\\frac{1}{\\sqrt{2}}\\left(e\^0\|0\\rangle + e\^{\\pi
i}\|1\\rangle\\right) \\\\ &= \\frac{1}{\\sqrt{2}}(\|0\\rangle -
\|1\\rangle) \\\\ &= \\ket{-} \\\\ \\end{aligned} \\tag{3}
\\end{equation}\\end{split}\\\]
:::

To summarize, [\\(\\text{QFT}\|0\\rangle = \\ket{+}\\)]{.math
.notranslate .nohighlight} and [\\(\\text{QFT}\|1\\rangle =
\\ket{-}\\)]{.math .notranslate .nohighlight} which can be achieved by
applying Hadamard gates.

Let us now extend this and see how we can apply this to
[\\(n=3\\)]{.math .notranslate .nohighlight} qubits.

For [\\(n=3, N = 2\^3 = 8\\)]{.math .notranslate .nohighlight} and we
would like to perform [\\(\\text{QFT}\|101\\rangle\\)]{.math
.notranslate .nohighlight} which in binary is [\\(2\^2 \\times 1 + 2\^1
\\times 0 + 2\^0 \\times 1 = 5\\)]{.math .notranslate .nohighlight}:

::: {.math .notranslate .nohighlight}
\\\[\\begin{split}\\begin{equation} \\begin{aligned}
\\text{QFT}\|101\\rangle = \\text{QFT}\|5\\rangle &=
\\frac{1}{\\sqrt{8}}\\sum\_{y=0}\^{8-1} e\^{\\frac{2\\pi
i(5)y}{8}}\|y\\rangle \\\\ &= \\frac{1}{\\sqrt{8}} \[ e\^{0}\\ket{0} +
e\^{\\frac{5i\\pi (1)}{4}}\\ket{1} + e\^{\\frac{5i\\pi (2)}{4}}\\ket{2}
+\...++ e\^{\\frac{5i\\pi (7)}{4}}\\ket{7} \] \\\\ &=
\\frac{1}{\\sqrt{8}} \[ \\ket{000} + e\^{\\frac{5i\\pi
(1)}{4}}\\ket{001} + e\^{\\frac{5i\\pi (2)}{4}}\\ket{010} +\...++
e\^{\\frac{5i\\pi (7)}{4}}\\ket{111} \] \\\\ &= (0.35+0i) \\ket{000} +
(-0.25-0.25i)\\ket{001} + (0+0.35i)\\ket{010} +\...+
(-0.25+0.25i)\\ket{111} \\\\ \\end{aligned} \\tag{4}
\\end{equation}\\end{split}\\\]
:::

where we have used the fact that [\\(e\^{i\\theta} = \\cos(\\theta) +
i\\sin(\\theta).\\)]{.math .notranslate .nohighlight}

Here, we see how in addition to the Hadamard gates, we need some phase
gates to apply the appropriate phases to the basis states. It turns out
that the gate we need is the controlled [\\(R_k\\)]{.math .notranslate
.nohighlight} rotation where the [\\(R_k\\)]{.math .notranslate
.nohighlight} gate is denoted by:

::: {.math .notranslate .nohighlight}
\\\[\\begin{split}\\begin{equation} R_k = \\begin{bmatrix} 1 & 0 \\\\ 0
& e\^{2\\pi i/ 2\^{k}} \\end{bmatrix} \\tag{5}
\\end{equation}\\end{split}\\\]
:::

Here is a generalized ciruit for a [\\(n\\)]{.math .notranslate
.nohighlight}-qubit quantum Fourier transform:

![qft](../../_images/qft.png){.no-scaled-link style="width: 600px;"}

Below we show the code for a QFT implementation in CUDA-Q based on the
...
We can verify that this is the correct answer as above we worked out
that:
...
\\text{QFT}\|101\\rangle = \\text{QFT}\|5\\rangle &=
\\frac{1}{\\sqrt{8}}\\sum\_{y=0}\^{8-1} e\^{\\frac{2\\pi
i(5)y}{8}}\|y\\rangle \\\\ &= (0.35+0i) \\ket{000} +
(-0.25-0.25i)\\ket{001} + (0+0.35i)\\ket{010} +\...+
(-0.25+0.25i)\\ket{111}. \\\\ \\end{aligned} \\tag{6}
\\end{equation}\\end{split}\\\]
:::

Barring the gates used in the state preparation step, the circuit starts
off by implementing a Hadamard gate and then [\\(n-1\\)]{.math
.notranslate .nohighlight} rotations on the zeroth qubit - a total of
[\\(n\\)]{.math .notranslate .nohighlight} gates. This is followed by a
Hadamard and [\\(n-2\\)]{.math .notranslate .nohighlight} conditional
rotations on the first qubit which totals to [\\(n -1\\)]{.math
.notranslate .nohighlight} gates. If we continue the series, we get
[\\(n + (n-1) + (n-2)\... = n(n+1)/2\\)]{.math .notranslate
.nohighlight} gates. Hence, this circuit provides an algorithm with
[\\(O(n\^2)\\)]{.math .notranslate .nohighlight} gates for computing the
QFT.

The best classical algorithms for computing fast Fourier transforms on
[\\(2\^{n}\\)]{.math .notranslate .nohighlight} elements require
[\\(O(n2\^{n})\\)]{.math .notranslate .nohighlight} gates. This means
that it requires exponentially more operations to compute the fast
Fourier transform on a classical computer than it does to implement the
QFT on a quantum computer.

Why are we not using QFT for real life applications then? The problem
lies in quantum measurement. The quantum-Fourier-transformed amplitudes
cannot be accessed by quantum measurement. However there are other
quantum algorithms that do make use of QFT such as Shor's algorithm.

One can also invert the QFT where the circuit is executed in reverse
with the inverse of each gate. The figure below shows the general
[\\(n\\)]{.math .notranslate .nohighlight}-qubit inverse QFT. Why don't
you try implementing this in CUDA-Q?

![qft](../../_images/inverse_qft.png){.no-scaled-link
style="width: 600px;"}

::: {#Quantum-Fourier-Transform-revisited .section}
## Quantum Fourier Transform revisited[¶](#Quantum-Fourier-Transform-revisited "Permalink to this heading"){.headerlink}

We provided one implementation of the Quantum Fourier Transform above.
To demonstrate some of the other features of CUDA-Q, let's define a new
kernel for the Quantum Fourier Transform, which we'll call
[`quantum_fourier_transform2`{.docutils .literal .notranslate}]{.pre}.
Pay attention to how the kernel definition differs from the example
above.

Since the Quantum Fourier Transform is a unitary operator, its inverse
is its adjoint. Therefore, once we have implemented the Quantum Fourier
Transform as a kernel in CUDA-Q, we can use the built-in
...
Let's see that this approach gives us the same results as the section
above.
...
::: highlight
    %4:4 = cc.loop while ((%arg2 = %c0_i64, %arg3 = %2, %arg4 = %1, %arg5 = %0) -> (i64, i64, i64, f64)) {
      %5 = arith.cmpi slt, %arg2, %3 : i64
      cc.condition %5(%arg2, %arg3, %arg4, %arg5 : i64, i64, i64, f64)
    } do {
    ^bb0(%arg2: i64, %arg3: i64, %arg4: i64, %arg5: f64):
      %5 = quake.extract_ref %arg1[%arg2] : (!quake.veq<?>, i64) -> !quake.ref
      quake.h %5 : (!quake.ref) -> ()
      %6 = arith.addi %arg2, %c1_i64 : i64
      %7:3 = cc.loop while ((%arg6 = %6, %arg7 = %arg4, %arg8 = %arg5) -> (i64, i64, f64)) {
        %8 = arith.cmpi slt, %arg6, %3 : i64
        cc.condition %8(%arg6, %arg7, %arg8 : i64, i64, f64)
      } do {
      ^bb0(%arg6: i64, %arg7: i64, %arg8: f64):
        %8 = arith.subi %arg6, %arg2 : i64
        %9 = arith.addi %8, %c1_i64 : i64
        %10 = math.ipowi %c2_i64, %9 : i64
        %11 = cc.cast signed %10 : (i64) -> f64
        %12 = arith.divf %cst, %11 : f64
        %13 = quake.extract_ref %arg1[%arg6] : (!quake.veq<?>, i64) -> !quake.ref
        %14 = quake.extract_ref %arg1[%arg2] : (!quake.veq<?>, i64) -> !quake.ref
        quake.r1 (%12) [%13] %14 : (f64, !quake.ref, !quake.ref) -> ()
        cc.continue %arg6, %arg6, %12 : i64, i64, f64
      } step {
      ^bb0(%arg6: i64, %arg7: i64, %arg8: f64):
        %8 = arith.addi %arg6, %c1_i64 : i64
        cc.continue %8, %arg7, %arg8 : i64, i64, f64
      }
      cc.continue %arg2, %arg2, %7#1, %7#2 : i64, i64, i64, f64
    } step {
    ^bb0(%arg2: i64, %arg3: i64, %arg4: i64, %arg5: f64):
      %5 = arith.addi %arg2, %c1_i64 : i64
      cc.continue %5, %arg3, %arg4, %arg5 : i64, i64, i64, f64
    }
    %4:4 = cc.loop while ((%arg2 = %c0_i64, %arg3 = %2, %arg4 = %1, %arg5 = %0) -> (i64, i64, i64, f64)) {
      %5 = arith.cmpi slt, %arg2, %3 : i64
      cc.condition %5(%arg2, %arg3, %arg4, %arg5 : i64, i64, i64, f64)
    ...
    %18:3 = cc.loop while ((%arg7 = %17, %arg8 = %arg4, %arg9 = %arg5) -> (i64, i64, f64)) {
      %19 = arith.cmpi slt, %arg7, %3 : i64
      cc.condition %19(%arg7, %arg8, %arg9 : i64, i64, f64)
    } do {
    ^bb0(%arg7: i64, %arg8: i64, %arg9: f64):
      %19 = arith.subi %arg7, %arg2 : i64
      %20 = arith.addi %19, %c1_i64 : i64
      %21 = math.ipowi %c2_i64, %20 : i64
      %22 = cc.cast signed %21 : (i64) -> f64
      %23 = arith.divf %cst, %22 : f64
      %24 = quake.extract_ref %arg1[%arg7] : (!quake.veq<?>, i64) -> !quake.ref
      %25 = quake.extract_ref %arg1[%arg2] : (!quake.veq<?>, i64) -> !quake.ref
      quake.r1 (%23) [%24] %25 : (f64, !quake.ref, !quake.ref) -> ()
      cc.continue %arg7, %arg7, %23 : i64, i64, f64
    } step {
    ^bb0(%arg7: i64, %arg8: i64, %arg9: f64):
      %19 = arith.addi %arg7, %c1_i64 : i64
      cc.continue %19, %arg8, %arg9 : i64, i64, f64
    }
    %18:3 = cc.loop while ((%arg7 = %17, %arg8 = %arg4, %arg9 = %arg5) -> (i64, i64, f64)) {
      %19 = arith.cmpi slt, %arg7, %3 : i64
      cc.condition %19(%arg7, %arg8, %arg9 : i64, i64, f64)
...
::: {.output_area .docutils .container}
::: highlight
    CUDA-Q Version  (https://github.com/NVIDIA/cuda-quantum 0f2f17cfd94e101ca03b421a65721ff577cf892f)
:::
:::
:::
:::
