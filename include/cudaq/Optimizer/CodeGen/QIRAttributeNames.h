...
static constexpr const char QIRDynamicQubitsManagementFlagName[] = "dynamic_qubit_management";
static constexpr const char QIRDynamicResultManagementFlagName[] = "dynamic_result_management";
...
static constexpr const char QIRFloatComputationsFlagName[] = "float_computations";
static constexpr const char QIRBackwardsBranchingFlagName[] = "backwards_branching";
static constexpr const char QIRMultipleTargetBranchingFlagName[] = "multiple_target_branching";
static constexpr const char QIRMultipleReturnPointsFlagName[] = "multiple_return_points";
