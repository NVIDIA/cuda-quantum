...
-   Migrating Kernels from [`sample`{.docutils .literal
    .notranslate}]{.pre} to [`run`{.docutils .literal
    .notranslate}]{.pre}
-   
...
::: {#migrating-kernels-from-sample-to-run .section}
[]{#sample-to-run-migration}

# Migrating Kernels from [`sample`{.docutils .literal .notranslate}]{.pre} to [`run`{.docutils .literal .notranslate}]{.pre}[¶](#migrating-kernels-from-sample-to-run "Permalink to this heading"){.headerlink}
