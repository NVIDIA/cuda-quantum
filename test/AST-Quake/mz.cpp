...
// CHECK:           quake.mz %[[VAL_2]] : (!quake.veq<20>) -> !quake.measurements<20>
// CHECK:           return
// CHECK:         }
// clang-format on
...
// CHECK:           %[[VAL_81:.*]] = quake.mz %[[VAL_0]], %[[VAL_3]], %[[VAL_6]], %[[VAL_7]] : (!quake.ref, !quake.veq<4>, !quake.veq<2>, !quake.ref) -> !quake.measurements<8>
...
// CHECK:           %[[VAL_112:.*]] = quake.mz %[[VAL_4]], %[[VAL_7]], %[[VAL_10]], %[[VAL_11]] : (!quake.ref, !quake.veq<?>, !quake.veq<?>, !quake.ref) -> !quake.measurements<?>
