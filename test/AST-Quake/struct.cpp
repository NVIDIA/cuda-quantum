...
// CHECK-DAG:       %[[VAL_4:.*]] = cc.alloca !cc.struct<"ArgumentThing" {i32, i32, f64}>
// CHECK:           cc.store %[[VAL_0]], %[[VAL_4]] : !cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>
// CHECK:           %[[VAL_5:.*]] = cc.compute_ptr %[[VAL_4]][0, 0] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_6:.*]] = cc.load %[[VAL_5]] : !cc.ptr<i32>
// CHECK:           %[[VAL_7:.*]] = cc.compute_ptr %[[VAL_4]][0, 1] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_8:.*]] = cc.load %[[VAL_7]] : !cc.ptr<i32>
// CHECK:           %[[VAL_9:.*]] = cc.compute_ptr %[[VAL_4]][0, 2] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<f64>
...
// CHECK-DAG:       %[[VAL_2:.*]] = cc.alloca !cc.struct<"ArgumentThing" {i32, i32, f64}>
// CHECK:           cc.store %[[VAL_0]], %[[VAL_2]] : !cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>
// CHECK:           %[[VAL_3:.*]] = cc.compute_ptr %[[VAL_2]][0, 0] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_4:.*]] = cc.load %[[VAL_3]] : !cc.ptr<i32>
// CHECK:           %[[VAL_5:.*]] = cc.compute_ptr %[[VAL_2]][0, 1] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_6:.*]] = cc.load %[[VAL_5]] : !cc.ptr<i32>
// CHECK:           %[[VAL_7:.*]] = cc.compute_ptr %[[VAL_2]][0, 2] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<f64>
// CHECK:           %[[VAL_8:.*]] = cc.load %[[VAL_7]] : !cc.ptr<f64>
// CHECK:           call @_Z15debug_the_thingiid(%[[VAL_4]], %[[VAL_6]], %[[VAL_8]]) : (i32, i32, f64) -> ()
// CHECK:           %[[VAL_9:.*]] = call @_Z16help_me_help_youv() : () -> !cc.struct<"ResultThing" {i1, i1, i1, i32}>
// CHECK:           %[[VAL_10:.*]] = cc.alloca !cc.struct<"ResultThing" {i1, i1, i1, i32}>
// CHECK:           cc.store %[[VAL_9]], %[[VAL_10]] : !cc.ptr<!cc.struct<"ResultThing" {i1, i1, i1, i32}>>
// CHECK:           %[[VAL_11:.*]] = cc.compute_ptr %[[VAL_10]][0, 3] : (!cc.ptr<!cc.struct<"ResultThing" {i1, i1, i1, i32}>>) -> !cc.ptr<i32>
// CHECK:           cc.store %[[VAL_1]], %[[VAL_11]] : !cc.ptr<i32>
// CHECK:           %[[VAL_12:.*]] = cc.load %[[VAL_10]] : !cc.ptr<!cc.struct<"ResultThing" {i1, i1, i1, i32}>>
// CHECK:           return %[[VAL_12]] : !cc.struct<"ResultThing" {i1, i1, i1, i32}>
// CHECK:         }
// clang-format on
...
// CHECK:           call @_Z15debug_the_thingiid(%[[VAL_6]], %[[VAL_8]], %[[VAL_10]]) : (i32, i32, f64) -> ()
// CHECK:           %[[VAL_11:.*]] = cc.alloca !cc.struct<"ResultThing" {i1, i1, i1, i32}>
// CHECK:           call @_ZN11ResultThingC1Ev(%[[VAL_11]]) : (!cc.ptr<!cc.struct<"ResultThing" {i1, i1, i1, i32}>>) -> ()
// CHECK:           %[[VAL_12:.*]] = cc.compute_ptr %[[VAL_11]][0, 0] : (!cc.ptr<!cc.struct<"ResultThing" {i1, i1, i1, i32}>>) -> !cc.ptr<i1>
// CHECK:           %[[VAL_13:.*]] = cc.compute_ptr %[[VAL_4]][0, 0] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_14:.*]] = cc.load %[[VAL_13]] : !cc.ptr<i32>
// CHECK:           %[[VAL_15:.*]] = arith.cmpi sgt, %[[VAL_14]], %[[VAL_3]] : i32
// CHECK:           cc.store %[[VAL_15]], %[[VAL_12]] : !cc.ptr<i1>
// CHECK:           %[[VAL_16:.*]] = cc.compute_ptr %[[VAL_11]][0, 1] : (!cc.ptr<!cc.struct<"ResultThing" {i1, i1, i1, i32}>>) -> !cc.ptr<i1>
// CHECK:           %[[VAL_17:.*]] = cc.compute_ptr %[[VAL_4]][0, 1] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_18:.*]] = cc.load %[[VAL_17]] : !cc.ptr<i32>
// CHECK:           %[[VAL_19:.*]] = arith.cmpi sgt, %[[VAL_18]], %[[VAL_2]] : i32
// CHECK:           cc.store %[[VAL_19]], %[[VAL_16]] : !cc.ptr<i1>
// CHECK:           %[[VAL_20:.*]] = cc.compute_ptr %[[VAL_11]][0, 2] : (!cc.ptr<!cc.struct<"ResultThing" {i1, i1, i1, i32}>>) -> !cc.ptr<i1>
// CHECK:           %[[VAL_21:.*]] = cc.compute_ptr %[[VAL_4]][0, 2] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<f64>
// CHECK:           %[[VAL_22:.*]] = cc.load %[[VAL_21]] : !cc.ptr<f64>
// CHECK:           %[[VAL_23:.*]] = arith.cmpf one, %[[VAL_22]], %[[VAL_1]] : f64
// CHECK:           cc.store %[[VAL_23]], %[[VAL_20]] : !cc.ptr<i1>
// CHECK:           %[[VAL_24:.*]] = cc.compute_ptr %[[VAL_11]][0, 3] : (!cc.ptr<!cc.struct<"ResultThing" {i1, i1, i1, i32}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_25:.*]] = cc.compute_ptr %[[VAL_4]][0, 0] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_26:.*]] = cc.load %[[VAL_25]] : !cc.ptr<i32>
// CHECK:           %[[VAL_27:.*]] = cc.compute_ptr %[[VAL_4]][0, 1] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_28:.*]] = cc.load %[[VAL_27]] : !cc.ptr<i32>
// CHECK:           %[[VAL_29:.*]] = arith.subi %[[VAL_26]], %[[VAL_28]] : i32
// CHECK:           cc.store %[[VAL_29]], %[[VAL_24]] : !cc.ptr<i32>
// CHECK:           %[[VAL_30:.*]] = cc.load %[[VAL_11]] : !cc.ptr<!cc.struct<"ResultThing" {i1, i1, i1, i32}>>
// CHECK:           return %[[VAL_30]] : !cc.struct<"ResultThing" {i1, i1, i1, i32}>
// CHECK:         }
// clang-format on
...
// CHECK-SAME:      %[[VAL_0:.*]]: !cc.struct<"ArgumentThing" {i32, i32, f64}>) -> !cc.struct<{i1, i32, i16, i32}>
// CHECK-DAG:       %[[VAL_1:.*]] = arith.constant 4 : i32
// CHECK-DAG:       %[[VAL_2:.*]] = arith.constant 2 : i32
// CHECK-DAG:       %[[VAL_3:.*]] = cc.alloca !cc.struct<"ArgumentThing" {i32, i32, f64}>
// CHECK:           cc.store %[[VAL_0]], %[[VAL_3]] : !cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>
// CHECK:           %[[VAL_4:.*]] = cc.compute_ptr %[[VAL_3]][0, 0] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_5:.*]] = cc.load %[[VAL_4]] : !cc.ptr<i32>
// CHECK:           %[[VAL_6:.*]] = cc.compute_ptr %[[VAL_3]][0, 1] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_7:.*]] = cc.load %[[VAL_6]] : !cc.ptr<i32>
// CHECK:           %[[VAL_8:.*]] = cc.compute_ptr %[[VAL_3]][0, 2] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<f64>
// CHECK:           %[[VAL_9:.*]] = cc.load %[[VAL_8]] : !cc.ptr<f64>
// CHECK:           call @_Z15debug_the_thingiid(%[[VAL_5]], %[[VAL_7]], %[[VAL_9]]) : (i32, i32, f64) -> ()
// CHECK:           %[[VAL_10:.*]] = cc.alloca !cc.struct<{i1, i32, i16, i32}>
// CHECK:           call @_ZN2S61TC1Ev(%[[VAL_10]]) : (!cc.ptr<!cc.struct<{i1, i32, i16, i32}>>) -> ()
// CHECK:           %[[VAL_11:.*]] = cc.compute_ptr %[[VAL_10]][0, 0] : (!cc.ptr<!cc.struct<{i1, i32, i16, i32}>>) -> !cc.ptr<i1>
// CHECK:           %[[VAL_12:.*]] = cc.compute_ptr %[[VAL_3]][0, 0] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_13:.*]] = cc.load %[[VAL_12]] : !cc.ptr<i32>
// CHECK:           %[[VAL_14:.*]] = arith.cmpi sgt, %[[VAL_13]], %[[VAL_2]] : i32
// CHECK:           cc.store %[[VAL_14]], %[[VAL_11]] : !cc.ptr<i1>
// CHECK:           %[[VAL_15:.*]] = cc.compute_ptr %[[VAL_10]][0, 2] : (!cc.ptr<!cc.struct<{i1, i32, i16, i32}>>) -> !cc.ptr<i16>
// CHECK:           %[[VAL_16:.*]] = cc.compute_ptr %[[VAL_3]][0, 1] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
...
// CHECK:           %[[VAL_20:.*]] = cc.compute_ptr %[[VAL_10]][0, 3] : (!cc.ptr<!cc.struct<{i1, i32, i16, i32}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_21:.*]] = cc.compute_ptr %[[VAL_3]][0, 2] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<f64>
// CHECK:           %[[VAL_22:.*]] = cc.load %[[VAL_21]] : !cc.ptr<f64>
// CHECK:           %[[VAL_23:.*]] = arith.fptosi %[[VAL_22]] : f64 to i32
// CHECK:           cc.store %[[VAL_23]], %[[VAL_20]] : !cc.ptr<i32>
// CHECK:           %[[VAL_24:.*]] = cc.compute_ptr %[[VAL_10]][0, 1] : (!cc.ptr<!cc.struct<{i1, i32, i16, i32}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_25:.*]] = cc.compute_ptr %[[VAL_3]][0, 0] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_26:.*]] = cc.load %[[VAL_25]] : !cc.ptr<i32>
// CHECK:           %[[VAL_27:.*]] = cc.compute_ptr %[[VAL_3]][0, 1] : (!cc.ptr<!cc.struct<"ArgumentThing" {i32, i32, f64}>>) -> !cc.ptr<i32>
// CHECK:           %[[VAL_28:.*]] = cc.load %[[VAL_27]] : !cc.ptr<i32>
// CHECK:           %[[VAL_29:.*]] = arith.subi %[[VAL_26]], %[[VAL_28]] : i32
// CHECK:           cc.store %[[VAL_29]], %[[VAL_24]] : !cc.ptr<i32>
// CHECK:           %[[VAL_30:.*]] = cc.load %[[VAL_10]] : !cc.ptr<!cc.struct<{i1, i32, i16, i32}>>
// CHECK:           return %[[VAL_30]] : !cc.struct<{i1, i32, i16, i32}>
// CHECK:         }
// clang-format on
