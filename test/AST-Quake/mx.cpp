...
// Same test as `./mz.cpp` except with `mx`
...
// CHECK:           quake.mx %[[VAL_2]] : (!quake.veq<20>) -> !cc.stdvec<!quake.measure>
// CHECK:           return
// CHECK:         }
// clang-format on
...
// CHECK:           %[[VAL_81:.*]] = quake.mx %[[VAL_0]], %[[VAL_3]], %[[VAL_6]], %[[VAL_7]] : (!quake.ref, !quake.veq<4>, !quake.veq<2>, !quake.ref) -> !cc.stdvec<!quake.measure>
...
// CHECK:           %[[VAL_112:.*]] = quake.mx %[[VAL_4]], %[[VAL_7]], %[[VAL_10]], %[[VAL_11]] : (!quake.ref, !quake.veq<?>, !quake.veq<?>, !quake.ref) -> !cc.stdvec<!quake.measure>
