...
// CHECK-LABEL:   func.func @__nvqpp__mlirgen__function_qubit_values_to_integer._Z23qubit_values_to_integerRKSt6vectorIbSaIbEE(
// CHECK-SAME:      %[[VAL_0:.*]]: !cc.stdvec<i1>) -> i64 attributes {"cudaq-entrypoint", "cudaq-kernel", no_this} {
