...
// ADAPT:         %[[VAL_2:.*]] = tail call i1 @__quantum__qis__read_result(%Result* nonnull inttoptr (i64 1 to %Result*))
...
// ADAPT:         %[[VAL_3:.*]] = tail call i1 @__quantum__qis__read_result(%Result* nonnull inttoptr (i64 2 to %Result*))
...
// ADAPT:         %[[VAL_4:.*]] = tail call i1 @__quantum__qis__read_result(%Result* nonnull inttoptr (i64 3 to %Result*))
...
// ADAPT:         %[[VAL_5:.*]] = tail call i1 @__quantum__qis__read_result(%Result* nonnull inttoptr (i64 4 to %Result*))
...
// ADAPT:         %[[VAL_6:.*]] = tail call i1 @__quantum__qis__read_result(%Result* nonnull inttoptr (i64 5 to %Result*))
...
// ADAPT:         %[[VAL_7:.*]] = tail call i1 @__quantum__qis__read_result(%Result* nonnull inttoptr (i64 6 to %Result*))
// ADAPT:         ret void
// ADAPT:       }
