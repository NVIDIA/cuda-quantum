...
// CHECK:         %[[VAL_12:.*]] = load i1, ptr %[[VAL_9]], align 1
// CHECK:         %[[VAL_13:.*]] = tail call ptr @__quantum__qis__mz__to__register(ptr %[[VAL_4]], ptr nonnull @cstr.623100)
// CHECK:         %[[VAL_15:.*]] = load i1, ptr %[[VAL_13]], align 1
