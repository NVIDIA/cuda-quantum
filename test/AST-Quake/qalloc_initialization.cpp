...
// QIR:         %[[VAL_4:.*]] = load %[[VAL_3]]*, %[[VAL_3]]** %[[VAL_2]], align 8
...
// QIR:         %[[VAL_6:.*]] = load %[[VAL_3]]*, %[[VAL_3]]** %[[VAL_5]], align 8
...
// QIR:         %[[VAL_10:.*]] = load i1, i1* %[[VAL_9]], align 1
...
// QIR:         store double 0.000000e+00, double* %[[VAL_2]], align 8
...
// QIR:         %[[VAL_15:.*]] = load %[[VAL_12]]*, %[[VAL_12]]** %[[VAL_14]], align 8
...
// QIR:         %[[VAL_19:.*]] = load i1, i1* %[[VAL_18]], align 1
...
// QIR:         store double 1.000000e+00, double* %[[VAL_3]], align 8
// QIR:         %[[VAL_4:.*]] = getelementptr inbounds [4 x { double, double }], [4 x { double, double }]* %[[VAL_0]], i64 0, i64 1, i32 0
// QIR:         store double 7.500000e-01, double* %[[VAL_4]], align 8
// QIR:         %[[VAL_5:.*]] = getelementptr inbounds [4 x { double, double }], [4 x { double, double }]* %[[VAL_0]], i64 0, i64 1, i32 1
// QIR:         store double 2.500000e-01, double* %[[VAL_5]], align 8
// QIR:         %[[VAL_6:.*]] = getelementptr inbounds [4 x { double, double }], [4 x { double, double }]* %[[VAL_0]], i64 0, i64 2, i32 0
// QIR:         store double 1.000000e+00, double* %[[VAL_6]], align 8
// QIR:         %[[VAL_7:.*]] = getelementptr inbounds [4 x { double, double }], [4 x { double, double }]* %[[VAL_0]], i64 0, i64 2, i32 1
// QIR:         %[[VAL_8:.*]] = bitcast double* %[[VAL_7]] to i8*
...
// QIR:         store double %[[VAL_18]], double* %[[VAL_19]], align 8
...
// QIR:         store double %[[VAL_24]], double* %[[VAL_25]], align 8
...
// QIR:         store double %[[VAL_26]], double* %[[VAL_27]], align 8
...
// QIR:         %[[VAL_34:.*]] = load %[[VAL_33]]*, %[[VAL_33]]** %[[VAL_32]], align 8
...
// QIR:         %[[VAL_36:.*]] = load %[[VAL_33]]*, %[[VAL_33]]** %[[VAL_35]], align 8
...
// QIR:         %[[VAL_40:.*]] = load i1, i1* %[[VAL_39]], align 1
...
// QIR:         %[[VAL_15:.*]] = load %[[VAL_14]]*, %[[VAL_14]]** %[[VAL_13]], align 8
...
// QIR:         %[[VAL_11:.*]] = alloca i8, i64 %[[VAL_6]], align 1
// QIR:         br label %[[VAL_12:.*]]
// QIR:       .lr.ph:                                           ; preds = %[[VAL_10]], %[[VAL_8]]
...
// QIR:         %[[VAL_17:.*]] = load %[[VAL_16]]*, %[[VAL_16]]** %[[VAL_15]], align 8
...
// QIR:         %[[VAL_20:.*]] = alloca i8, i64 %[[VAL_6]], align 1
...
// QIR:         %[[VAL_0:.*]] = alloca [2 x { double, double }], align 8
...
// QIR:         %[[VAL_10:.*]] = load %[[VAL_9]]*, %[[VAL_9]]** %[[VAL_8]], align 8
