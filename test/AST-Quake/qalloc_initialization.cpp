...
// CHECK:           cc.store %[[CST_ZERO]], %[[VAL_9]] : !cc.ptr<f64>
// CHECK:           %[[VAL_10:.*]] = call @_ZNSt{{.*}}8literals16complex_literalsli1i{{.*}}Ee(%[[CST_ONE]]) : (f{{[0-9]+}}) -> complex<f64>
...
// CHECK:           cc.store %[[CST_ONE]], %[[VAL_13]] : !cc.ptr<f64>
// CHECK:           %[[VAL_14:.*]] = call @_ZNSt{{.*}}8literals16complex_literalsli1i{{.*}}Ee(%[[CST_ZERO]]) : (f{{[0-9]+}}) -> complex<f64>
