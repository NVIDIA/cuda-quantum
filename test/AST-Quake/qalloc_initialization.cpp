...
// CHECK:           %[[VAL_12:.*]] = call @_ZS{{.*}}(%[[VAL_9]], %[[VAL_11]]) : (!cc.ptr<f64>, !cc.ptr<complex<f64>>) -> complex<f64>
...
// CHECK:           %[[VAL_16:.*]] = call @_ZS{{.*}}(%[[VAL_13]], %[[VAL_15]]) : (!cc.ptr<f64>, !cc.ptr<complex<f64>>) -> complex<f64>
...
// QIR:         %[[VAL_7:.*]] = call { double, double } @_ZS{{.*}}(double* nonnull %[[VAL_0]], { double, double }* nonnull %[[VAL_2]])
...
// QIR:         %[[VAL_15:.*]] = call { double, double } @_ZS{{.*}}(double* nonnull %[[VAL_8]], { double, double }* nonnull %[[VAL_10]])
