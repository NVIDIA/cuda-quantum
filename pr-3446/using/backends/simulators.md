...
Previous](backends.html "CUDA-Q Backends"){.btn .btn-neutral
...
| .n          |             | noisy circuits  |      | ult) |          |
| otranslate} |             |                 |      | /    |          |
| \*          |             |                 |      | do   |          |
|             |             |                 |      | uble |          |
+-------------+-------------+-----------------+------+------+----------+
| `nvid       | State       | Large-scale     | m    | si   | 33+      |
| ia, option= | Vector      | simulation      | ulti | ngle |          |
| mgpu`{.code |             |                 | -GPU | (    |          |
| .docutils   |             |                 | mu   | defa |          |
| .literal    |             |                 | lti- | ult) |          |
| .n          |             |                 | node | /    |          |
...
| otranslate} |             |                 |      |      |          |
+-------------+-------------+-----------------+------+------+----------+
| `nvid       | State       | Asynchronous    | m    | si   | \< 33 /  |
| ia, option= | Vector      | distribution    | ulti | ngle | 32 (64   |
| mqpu`{.code |             | across multiple | -GPU | (    | GB)      |
| .docutils   |             | simulated QPUs  | mu   | defa |          |
| .literal    |             | to speedup      | lti- | ult) |          |
| .n          |             | applications    | node | /    |          |
| otranslate} |             |                 |      | do   |          |
| \*          |             |                 |      | uble |          |
+-------------+-------------+-----------------+------+------+----------+
...
| otranslate} |             |                 |      |      |          |
+-------------+-------------+-----------------+------+------+----------+
| `orca-photo | State       | Photonics       | CPU  | do   | Varies   |
| nics`{.code | Vector      |                 |      | uble | on qudit |
| .docutils   |             |                 |      |      | level    |
| .literal    |             |                 |      |      |          |
| .n          |             |                 |      |      |          |
| otranslate} |             |                 |      |      |          |
