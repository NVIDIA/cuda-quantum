...
std::string mockPort = "62234";
std::string backendStringTemplate = "qm;url;http://localhost:{}";
...
CUDAQ_TEST(QuantumMachinesTester, checkObserveSync) {
...
CUDAQ_TEST(QuantumMachinesTester, checkObserveAsync) {
...
CUDAQ_TEST(QuantumMachinesTester, checkObserveAsyncLoadFromFile) {
