...
TEST(OperatorExpressions, checkCustomOperatorSum) {
...

  {
    ...
    cudaq::matrix_handler::define("custom_sum_op0", {-1, -1}, func0);
    cudaq::matrix_handler::define("custom_sum_op1", {-1, -1}, func1);
  }

  auto op0 = cudaq::matrix_handler::instantiate("custom_sum_op0", {0, 1});
  auto op1 = cudaq::matrix_handler::instantiate("custom_sum_op1", {1, 2});
  auto sum = op0 + op1;
  ...
  op0 = cudaq::matrix_handler::instantiate("custom_sum_op0", {2, 3});
  op1 = cudaq::matrix_handler::instantiate("custom_sum_op1", {0, 2});
  sum = op0 + op1;
  sum_reverse = op1 + op0;
  difference = op0 - op1;
