...
TEST(OperatorExpressions, checkCustomProductOps) {
...

  {
    ...
    cudaq::matrix_handler::define("custom_prod_op0", {-1, -1}, func0);
    cudaq::matrix_handler::define("custom_prod_op1", {-1, -1}, func1);
  }

  auto op0 = cudaq::matrix_handler::instantiate("custom_prod_op0", {0, 1});
  auto op1 = cudaq::matrix_handler::instantiate("custom_prod_op1", {1, 2});
  ...
  op0 = cudaq::matrix_handler::instantiate("custom_prod_op0", {2, 3});
  op1 = cudaq::matrix_handler::instantiate("custom_prod_op1", {0, 2});
  product = op0 * op1;
  reverse = op1 * op0;
