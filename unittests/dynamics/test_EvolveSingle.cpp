...
TEST(EvolveTester, checkSimple) {
  ...
  auto result = cudaq::detail::evolveSingle(ham, dims, schedule, initialState,
...
TEST(EvolveTester, checkCompositeSystem) {
  ...
  auto result = cudaq::detail::evolveSingle(hamiltonian, dims, schedule,
                                            initialState, integrator, {},
