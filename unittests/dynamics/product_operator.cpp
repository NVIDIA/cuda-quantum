...
TEST(OperatorExpressions, checkProductOperatorAgainstScalars) {
  ...
  {
    auto product_op = cudaq::sum_op<cudaq::spin_handler>::x(0) * cudaq::sum_op<cudaq::spin_handler>::y(1);
  ...
  /// `spin product - double`
  {
    auto product_op = cudaq::sum_op<cudaq::spin_handler>::i(0) * cudaq::sum_op<cudaq::spin_handler>::z(1);
  ...
  {
    auto product_op = cudaq::sum_op<cudaq::spin_handler>::z(0) * cudaq::sum_op<cudaq::spin_handler>::y(1);
    auto scalar_op = cudaq::scalar_operator(value_0);
  ...
  /// `spin product *= double`
  {
    auto product = cudaq::sum_op<cudaq::spin_handler>::y(0) * cudaq::sum_op<cudaq::spin_handler>::i(1);
    product *= 2.0;
...
TEST(OperatorExpressions, checkProductOperatorAgainstProduct) {
  ...
  // `product_op + product_op`
  {
    auto term_0 = cudaq::matrix_op::position(0) *
                  cudaq::matrix_op::position(1);
    auto term_1 = cudaq::matrix_op::momentum(1) *
  ...
  {
    auto term_0 = cudaq::sum_op<cudaq::spin_handler>::z(0) * cudaq::sum_op<cudaq::spin_handler>::y(2);
    auto term_1 = cudaq::sum_op<cudaq::spin_handler>::x(2) * cudaq::sum_op<cudaq::spin_handler>::z(4);
  ...
  // `spin product - spin product`
  {
    ...
    auto term_1 = cudaq::sum_op<cudaq::spin_handler>::x(1) * cudaq::sum_op<cudaq::spin_handler>::y(2);
  ...
  // `product_op * product_op`
  {
    auto term_0 = cudaq::matrix_op::position(0) *
                  cudaq::matrix_op::position(1);
    auto term_1 =
        cudaq::matrix_op::momentum(1) * cudaq::matrix_op::parity(2);
  ...
  // `spin product * spin product`
  {
    auto term_0 = cudaq::sum_op<cudaq::spin_handler>::y(0) * cudaq::sum_op<cudaq::spin_handler>::x(1);
    auto term_1 = cudaq::sum_op<cudaq::spin_handler>::z(1) * cudaq::sum_op<cudaq::spin_handler>::i(3);
  ...
  // `spin product *= spin product`
  {
    auto term_0 = cudaq::sum_op<cudaq::spin_handler>::y(3) * cudaq::sum_op<cudaq::spin_handler>::y(1);
    auto term_1 = cudaq::sum_op<cudaq::spin_handler>::z(1) * cudaq::sum_op<cudaq::spin_handler>::x(0);
...
TEST(OperatorExpressions, checkProductOperatorAgainstOperatorSum) {
  ...
  // `product_op + sum_op`
  {
    auto product = cudaq::matrix_op::position(0) *
                   cudaq::matrix_op::position(1);
    auto original_sum = cudaq::matrix_op::momentum(1) +
                        cudaq::matrix_op::momentum(2);
  ...
  {
    auto product = cudaq::sum_op<cudaq::spin_handler>::x(0) * cudaq::sum_op<cudaq::spin_handler>::y(1);
    auto original_sum = cudaq::sum_op<cudaq::spin_handler>::z(1) + cudaq::sum_op<cudaq::spin_handler>::i(2);
  ...
  // `product_op - sum_op`
  {
    auto product = cudaq::matrix_op::position(0) *
                   cudaq::matrix_op::position(1);
    auto original_difference = cudaq::matrix_op::momentum(1) -
                               cudaq::matrix_op::momentum(2);
  ...
  // `spin product - spin sum`
  {
    auto product = cudaq::sum_op<cudaq::spin_handler>::y(0) * cudaq::sum_op<cudaq::spin_handler>::z(1);
    auto original_difference =
        cudaq::sum_op<cudaq::spin_handler>::x(1) - cudaq::sum_op<cudaq::spin_handler>::i(2);
  ...
  // `spin product * spin sum`
  {
    auto original_product =
        cudaq::sum_op<cudaq::spin_handler>::z(0) * cudaq::sum_op<cudaq::spin_handler>::y(1);
    auto sum = cudaq::sum_op<cudaq::spin_handler>::i(1) + cudaq::sum_op<cudaq::spin_handler>::x(2);
