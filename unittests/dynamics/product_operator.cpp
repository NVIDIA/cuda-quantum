...
TEST(OperatorExpressions, checkProductOperatorBasics) {
...

  {
    ...
    // Different degrees of freedom.
    {
      ...
      auto spin_matrix = cudaq::kronecker(utils::PauliZ_matrix(), utils::PauliX_matrix());
  ...
  // Scalar Ops against Elementary Ops
  {
    ...
    // matrix operator against constant from lambda
    {
      ...
      ASSERT_TRUE(product.degrees() == want_degrees);
      ASSERT_TRUE(reverse.degrees() == want_degrees);
      utils::checkEqual(scalar_op.evaluate() * op_matrix, product.to_matrix({{1, 2}}));
      utils::checkEqual(scalar_op.evaluate() * op_matrix, reverse.to_matrix({{1, 2}}));
    }
    ...
    // spin operator against constant from lambda
    {
      ...
      ASSERT_TRUE(product.degrees() == want_degrees);
      ASSERT_TRUE(reverse.degrees() == want_degrees);
      utils::checkEqual(scalar_op.evaluate() * op_matrix, product.to_matrix());
      utils::checkEqual(scalar_op.evaluate() * op_matrix, reverse.to_matrix());
    }
  }
}
...
TEST(OperatorExpressions, checkProductOperatorAgainstScalars) {
  ...
  /// `product_operator + double`
  {
    ...
    auto term_1 = cudaq::kronecker(utils::annihilate_matrix(level_count),
  ...
  /// `product_operator + complex<double>`
  {
    ...
    auto term_1 = cudaq::kronecker(utils::annihilate_matrix(level_count),
                                   utils::id_matrix(level_count));
    auto product = term_0 * term_1;
    auto scaled_identity = value_0 * utils::id_matrix(level_count * level_count);
  ...
  {
    auto product_op = cudaq::spin_operator::x(0) *
                      cudaq::spin_operator::y(1);
    ...
    auto term_0 = cudaq::kronecker(utils::id_matrix(2),
                                   utils::PauliX_matrix());
    auto term_1 = cudaq::kronecker(utils::PauliY_matrix(),
                                   utils::id_matrix(2));
    auto product = term_0 * term_1;
  ...
  /// `spin product - double`
  {
    auto product_op = cudaq::spin_operator::i(0) *
    ...
    auto term_0 = cudaq::kronecker(utils::id_matrix(2),
                                   utils::id_matrix(2));
    auto term_1 = cudaq::kronecker(utils::PauliZ_matrix(),
                                   utils::id_matrix(2));
    auto product = term_0 * term_1;
  ...
  {
    auto product_op = cudaq::spin_operator::z(0) *
                      cudaq::spin_operator::y(1);
    auto scalar_op = cudaq::scalar_operator(value_0);
  ...
  /// `product_operator *= double`
  {
    ...
    auto term_0 = cudaq::kronecker(utils::id_matrix(level_count),
                                   utils::annihilate_matrix(level_count));
    auto term_1 = cudaq::kronecker(utils::create_matrix(level_count),
                                   utils::id_matrix(level_count));
    auto product_matrix = term_0 * term_1;
    auto scaled_identity = 2.0 * utils::id_matrix(level_count * level_count);
  ...
  /// `spin product *= double`
  {
    auto product = cudaq::spin_operator::y(0) *
    ...
    auto term_0 = cudaq::kronecker(utils::id_matrix(2),
                                   utils::PauliY_matrix());
    auto term_1 = cudaq::kronecker(utils::id_matrix(2),
                                   utils::id_matrix(2));
    auto product_matrix = term_0 * term_1;
    auto scaled_identity = 2.0 * utils::id_matrix(2 * 2);
...
TEST(OperatorExpressions, checkProductOperatorAgainstElementary) {
  ...
  // `product_operator + matrix_operator`
  {
    ...
    auto elementary_matrix = cudaq::kronecker(
        utils::create_matrix(level_count), utils::id_matrix(level_count));
  ...
  {
    auto mp = cudaq::matrix_operator::annihilate(0);
    auto me = mp.get_terms()[0];
    auto sp = cudaq::spin_operator::x(1) * cudaq::spin_operator::x(1);
    //auto fp = cudaq::fermion_operator::?
    //auto s = me + sp;
    auto s = mp + sp;
    //auto r = sp + me;
    auto r = sp + mp;
    // auto r = fp + sp; auto r = sp + fp;
...
// FIXME: add tests to combine general product with spin product
TEST(OperatorExpressions, checkProductOperatorAgainstProduct) {
  ...
  // `product_operator + product_operator`
  {
    ...
    matrices_1_0 = {utils::id_matrix(level_count + 1),
                    ...
                    utils::id_matrix(level_count)};
    matrices_1_1 = {utils::annihilate_matrix(level_count + 1),
                    utils::id_matrix(level_count),
                    utils::id_matrix(level_count)};
  ...
  {
    auto term_0 = cudaq::spin_operator::z(0) *
                  cudaq::spin_operator::y(2);
    auto term_1 = cudaq::spin_operator::x(2) *
                  cudaq::spin_operator::z(4);
    ...
    std::vector<cudaq::matrix_2> matrices_0_0;
    std::vector<cudaq::matrix_2> matrices_0_1;
    matrices_0_0 = {utils::id_matrix(2),
                    utils::id_matrix(2),
                    utils::PauliZ_matrix()};
    matrices_0_1 = {utils::id_matrix(2),
                    utils::PauliY_matrix(),
                    utils::id_matrix(2)};

    std::vector<cudaq::matrix_2> matrices_1_0;
    std::vector<cudaq::matrix_2> matrices_1_1;
    matrices_1_0 = {utils::id_matrix(2),
                    utils::PauliX_matrix(),
                    utils::id_matrix(2)};
    matrices_1_1 = {utils::PauliZ_matrix(),
                    utils::id_matrix(2),
                    utils::id_matrix(2)};
  ...
  // `spin product - spin product`
  {
    ...
    auto term_1 = cudaq::spin_operator::x(1) *
                  cudaq::spin_operator::y(2);
    ...
    matrices_1_0 = {utils::id_matrix(2),
                    utils::PauliX_matrix(),
                    utils::id_matrix(2)};
    matrices_1_1 = {utils::PauliY_matrix(),
                    utils::id_matrix(2),
                    utils::id_matrix(2)};
  ...
  // `spin product * spin product`
  {
    auto term_0 = cudaq::spin_operator::y(0) *
                  cudaq::spin_operator::x(1);
    auto term_1 = cudaq::spin_operator::z(1) *
                  cudaq::spin_operator::i(3);
    ...
    matrices_1_0 = {utils::id_matrix(2),
                    utils::PauliZ_matrix(),
                    utils::id_matrix(2)};
    matrices_1_1 = {utils::id_matrix(2),
                    utils::id_matrix(2),
                    utils::id_matrix(2)};
  ...
  // `product_operator *= product_operator`
  {
    ...
    auto want_matrix = term_0_matrix * term_1_matrix;
    auto term1_only_matrix = cudaq::kronecker(utils::annihilate_matrix(level_count + 1), utils::create_matrix(level_count));
    utils::checkEqual(want_matrix, got_matrix);
  ...
  // `spin product *= spin product`
  {
    auto term_0 = cudaq::spin_operator::y(3) *
                  cudaq::spin_operator::y(1);
    auto term_1 = cudaq::spin_operator::z(1) *
    ...
    std::vector<cudaq::matrix_2> matrices_0_0;
    std::vector<cudaq::matrix_2> matrices_0_1;
    matrices_0_0 = {utils::PauliY_matrix(),
                    utils::id_matrix(2),
                    utils::id_matrix(2)};
    matrices_0_1 = {utils::id_matrix(2),
                    utils::PauliY_matrix(),
    ...
    auto want_matrix = term_0_matrix * term_1_matrix;
    auto term1_only_matrix = cudaq::kronecker(utils::PauliZ_matrix(), utils::PauliX_matrix());
    utils::checkEqual(want_matrix, got_matrix);
...
TEST(OperatorExpressions, checkProductOperatorAgainstOperatorSum) {
  ...
  // `product_operator + operator_sum`
  {
    ...
    std::vector<cudaq::matrix_2> matrices_1_1 = {
        ...
        utils::id_matrix(level_count), utils::id_matrix(level_count)};
    auto product_matrix =
        cudaq::kronecker(matrices_0_0.begin(), matrices_0_0.end()) *
        cudaq::kronecker(matrices_0_1.begin(), matrices_0_1.end());
    auto sum_matrix =
  ...
  {
    auto product = cudaq::spin_operator::x(0) *
                   cudaq::spin_operator::y(1);
    auto original_sum = cudaq::spin_operator::z(1) +
  ...
  // `spin product - spin sum`
  {
    auto product = cudaq::spin_operator::y(0) *
                   cudaq::spin_operator::z(1);
    auto original_difference = cudaq::spin_operator::x(1) -
                               cudaq::spin_operator::i(2);
  ...
  // `spin product * spin sum`
  {
    auto original_product = cudaq::spin_operator::z(0) *
                            cudaq::spin_operator::y(1);
...
TEST(OperatorExpressions, checkCustomProductOps) {
    ...
    std::vector<cudaq::matrix_2> matrices = {
      utils::number_matrix(level_count),
      utils::position_matrix(level_count + 2) * utils::create_matrix(level_count + 2),
    ...
    std::vector<cudaq::matrix_2> matrices_reverse = {
      utils::number_matrix(level_count),
      utils::create_matrix(level_count + 2) * utils::position_matrix(level_count + 2),
      utils::momentum_matrix(level_count + 1)};
    ...
    matrices = {
      ...
      utils::momentum_matrix(level_count) * utils::create_matrix(level_count),
      utils::number_matrix(level_count + 1)};
    expected = cudaq::kronecker(matrices.begin(), matrices.end());

    matrices_reverse = {
      utils::position_matrix(level_count + 3),
      utils::create_matrix(level_count) * utils::momentum_matrix(level_count),
      utils::number_matrix(level_count + 1)};
