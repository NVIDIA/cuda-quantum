...
TEST(OperatorExpressions, checkOperatorSumAgainstScalars) {
  ...
  // `sum_op + double`
  {
    auto original = cudaq::matrix_op::momentum(1) +
                    cudaq::matrix_op::position(2);
  ...
  {
    auto original =
        cudaq::matrix_op::parity(1) + cudaq::matrix_op::parity(2);
  ...
  {
    auto original = cudaq::sum_op<cudaq::spin_handler>::x(1) + cudaq::sum_op<cudaq::spin_handler>::y(2);
  ...
  {
    auto original =
        cudaq::matrix_op::parity(1) + cudaq::matrix_op::number(2);
  ...
  // `spin sum - double`
  {
    auto original = cudaq::sum_op<cudaq::spin_handler>::x(1) + cudaq::sum_op<cudaq::spin_handler>::z(2);
  ...
  {
    auto sum = cudaq::sum_op<cudaq::spin_handler>::i(1) + cudaq::sum_op<cudaq::spin_handler>::y(2);
  ...
  // `spin sum += double`
  {
    auto sum = cudaq::sum_op<cudaq::spin_handler>::y(1) + cudaq::sum_op<cudaq::spin_handler>::y(2);
  ...
  // `sum_op += std::complex<double>`
  {
    auto sum = cudaq::matrix_op::momentum(1) +
               cudaq::matrix_op::squeeze(2);
  ...
  {
    auto sum =
        cudaq::matrix_op::parity(1) + cudaq::matrix_op::position(2);
  ...
  {
    auto sum =
        cudaq::matrix_op::position(1) + cudaq::matrix_op::number(2);
  ...
  {
    auto sum =
        cudaq::matrix_op::number(1) + cudaq::matrix_op::identity(2);
  ...
  // `spin sum -= scalar_operator`
  {
    auto sum = cudaq::sum_op<cudaq::spin_handler>::z(1) + cudaq::sum_op<cudaq::spin_handler>::y(2);
  ...
  {
    auto sum =
        cudaq::matrix_op::squeeze(1) + cudaq::matrix_op::squeeze(2);
  ...
  // `spin sum *= double`
  {
    auto sum = cudaq::sum_op<cudaq::spin_handler>::y(1) + cudaq::sum_op<cudaq::spin_handler>::i(2);
  ...
  {
    auto sum =
        cudaq::matrix_op::displace(1) + cudaq::matrix_op::parity(2);
  ...
  {
    auto sum =
        cudaq::matrix_op::parity(1) + cudaq::matrix_op::momentum(2);
...
TEST(OperatorExpressions, checkOperatorSumAgainstOperatorSum) {
  ...
  // `sum_op + sum_op`
  {
    auto sum_0 =
        cudaq::matrix_op::parity(1) + cudaq::matrix_op::parity(2);
    auto sum_1 = cudaq::matrix_op::parity(0) +
                 cudaq::matrix_op::number(1) +
