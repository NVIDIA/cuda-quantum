...
|---|---|
| [Defining codes](define-a-code) | `@qlx.code` authoring: validated CSS algebra, distance as typed evidence, parameterized families |
| [Gadgets and verification](gadgets-and-verification) | `@qlx.gadget` realizations, `implements=` claims checked against the objective, retry and commit points |
| [Devices and placement](devices-and-placement) | `@qlx.machine` regions and capabilities, placement constraints and witnesses, P0 → P1 refinement |
| [Magic states and protocols](magic-states-and-protocols) | `mpp` and rotations, resource kinds, the 15-to-1 distillation protocol |
| [Logical Clifford+T synthesis](logical-synthesis) | `qlx.compiler.synthesize` to a declared gate set under a projective precision bound |
