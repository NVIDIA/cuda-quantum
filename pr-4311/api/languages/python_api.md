...
:   A data-type representing the quantum state of the internal
    ...
    [[from_data]{.pre}]{.sig-name .descname}*[ ]{.w}[[=]{.pre}]{.p}[ ]{.w}[\<nanobind.nb_func]{.pre} [object]{.pre} [at]{.pre} [0x31d1780\>]{.pre}*[¶](#cudaq.State.from_data "Permalink to this definition"){.headerlink}
