...
-   [Backends](backends.html){.reference .internal}
    ...
    -   [Dynamics Simulation](dynamics_backends.html){.reference
        .internal}
    -   [Cloud](#){.current .reference .internal}
...
Previous](dynamics_backends.html "Dynamics Simulation"){.btn
.btn-neutral .float-left accesskey="p"} [Next []{.fa
.fa-arrow-circle-right
aria-hidden="true"}](cloud/braket.html "Amazon Braket"){.btn
...
::: {#cuda-q-cloud-backends .section}
# CUDA-Q Cloud Backends[¶](#cuda-q-cloud-backends "Permalink to this heading"){.headerlink}

CUDA-Q provides a number of options to access hardware resources (GPUs
and QPUs) through the cloud. Such options provide users with more
flexible access to simulation and hardware resources. See the links
below for more information on running CUDA-Q with cloud resources.
