...
// but without hte use of the builder and soley with CUDA Quantum kernel expressions
// Here we build up a CUDA Quantum kernel with N layers and each layer containing
// an arrangement of random SO(4) rotations. The algorithm leverages the CUDA Quantum
