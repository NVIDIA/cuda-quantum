    ...
    -   [Language Specification](../cudaq.html){.reference .internal}
        ...
        -   [12. Algorithmic
            ...
            -   [12.5. `cudaq::gradient`{.code .docutils .literal
                ...
                .internal}
        -   [13. Example Programs](#){.current .reference .internal}
            -   [13.1. Hello World - Simple Bell
                State](#hello-world-simple-bell-state){.reference
                .internal}
            -   [13.2. GHZ State Preparation and
                Sampling](#ghz-state-preparation-and-sampling){.reference
                .internal}
            -   [13.3. Quantum Phase
                Estimation](#quantum-phase-estimation){.reference
                .internal}
            -   [13.4. Deuteron Binding Energy Parameter
                Sweep](#deuteron-binding-energy-parameter-sweep){.reference
                .internal}
            -   [13.5. Grover's
                Algorithm](#grover-s-algorithm){.reference .internal}
            -   [13.6. Iterative Phase
                Estimation](#iterative-phase-estimation){.reference
                .internal}
...
-   [13. ]{.section-number}Example Programs
-   

::: {.rst-breadcrumbs-buttons role="navigation" aria-label="Sequential page navigation"}
[[]{.fa .fa-arrow-circle-left aria-hidden="true"}
Previous](algorithmic_primitives.html "12. Quantum Algorithmic Primitives"){.btn
.btn-neutral .float-left} [Next []{.fa .fa-arrow-circle-right
aria-hidden="true"}](../quake-dialect.html "Quake Dialect"){.btn
...
[13. ]{.section-number}Example Programs[¶](#example-programs "Permalink to this heading"){.headerlink}
======================================================================================================

::: {#hello-world-simple-bell-state .section}
[13.1. ]{.section-number}Hello World - Simple Bell State[¶](#hello-world-simple-bell-state "Permalink to this heading"){.headerlink}
------------------------------------------------------------------------------------------------------------------------------------
...
::: {#ghz-state-preparation-and-sampling .section}
[13.2. ]{.section-number}GHZ State Preparation and Sampling[¶](#ghz-state-preparation-and-sampling "Permalink to this heading"){.headerlink}
--------------------------------------------------------------------------------------------------------------------------------------------
...
::: {#quantum-phase-estimation .section}
[13.3. ]{.section-number}Quantum Phase Estimation[¶](#quantum-phase-estimation "Permalink to this heading"){.headerlink}
------------------------------------------------------------------------------------------------------------------------
...
::: {#deuteron-binding-energy-parameter-sweep .section}
[13.4. ]{.section-number}Deuteron Binding Energy Parameter Sweep[¶](#deuteron-binding-energy-parameter-sweep "Permalink to this heading"){.headerlink}
------------------------------------------------------------------------------------------------------------------------------------------------------
...
[13.5. ]{.section-number}Grover's Algorithm[¶](#grover-s-algorithm "Permalink to this heading"){.headerlink}
------------------------------------------------------------------------------------------------------------
...
::: {#iterative-phase-estimation .section}
[13.6. ]{.section-number}Iterative Phase Estimation[¶](#iterative-phase-estimation "Permalink to this heading"){.headerlink}
----------------------------------------------------------------------------------------------------------------------------
