...
static constexpr IntrinsicCode intrinsicTable[] = {
  ...
  func.func private @__nvqpp_cudaqConvertToInteger(%arg0 : !cc.stdvec<i1>) -> i64 {
    %c1_i64 = arith.constant 1 : i64
    %c0_i64 = arith.constant 0 : i64
    %0:2 = cc.loop while ((%arg1 = %c0_i64, %arg2 = %c0_i64) -> (i64, i64)) {
      %1 = cc.stdvec_size %arg0 : (!cc.stdvec<i1>) -> i64
      %2 = arith.cmpi ult, %arg2, %1 : i64
      cc.condition %2(%arg1, %arg2 : i64, i64)
    } do {
    ^bb0(%arg1: i64, %arg2: i64):
      %1 = cc.stdvec_data %arg0 : (!cc.stdvec<i1>) -> !cc.ptr<!cc.array<i1 x ?>>
      %2 = cc.compute_ptr %1[%arg2] : (!cc.ptr<!cc.array<i1 x ?>>, i64) -> !cc.ptr<i1>
      %3 = cc.load %2 : !cc.ptr<i1>
      %4 = cc.cast unsigned %3 : (i1) -> i64
      %5 = arith.shli %4, %arg2 : i64
      %6 = arith.ori %arg1, %5 : i64
      cc.continue %6, %arg2 : i64, i64
    } step {
    ^bb0(%arg1: i64, %arg2: i64):
      %1 = arith.addi %arg2, %c1_i64 : i64
      cc.continue %arg1, %1 : i64, i64
    }
    return %0#0 : i64
  }
)#"},
