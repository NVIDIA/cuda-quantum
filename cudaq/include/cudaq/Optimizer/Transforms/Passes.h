...
createObserveAnsatzPass(const std::vector<bool> &,
...
/// Name of the `quake.wire_set` generated by `MappingPrep` for device qubits.
static constexpr const char mappedWiresetName[] = "mapped_wireset";
/// Module attribute set by `MappingPrep`; survives `SymbolDCEPass`.
static constexpr const char qubitMappingRanAttrName[] =
    "quake.qubit_mapping_ran";
