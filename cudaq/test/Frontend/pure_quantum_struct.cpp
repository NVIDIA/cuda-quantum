...
// QIR:         %[[VAL_2:.*]] = tail call ptr @__quantum__rt__qubit_allocate()
// QIR:         %[[VAL_3:.*]] = tail call ptr @__quantum__rt__qubit_allocate()
// QIR:         tail call void @__quantum__qis__h(ptr %[[VAL_1]])
// QIR:         tail call void @__quantum__qis__s(ptr %[[VAL_2]])
// QIR:         tail call void @__quantum__qis__s(ptr %[[VAL_3]])
// QIR:         tail call void @__quantum__qis__x(ptr %[[VAL_2]])
// QIR-DAG:     tail call void @__quantum__rt__qubit_release(ptr %[[VAL_1]])
// QIR-DAG:     tail call void @__quantum__rt__qubit_release(ptr %[[VAL_2]])
// QIR-DAG:     tail call void @__quantum__rt__qubit_release(ptr %[[VAL_3]])
// QIR:         ret void
// QIR:       }

// QIR-LABEL: define void @__nvqpp__mlirgen__function_entry_ctor._Z10entry_ctorv() local_unnamed_addr {
// QIR:         %[[VAL_6:.*]] = tail call ptr @__quantum__rt__qubit_allocate()
// QIR:         tail call void @__quantum__qis__h(ptr %[[VAL_6]])
// QIR:         tail call void @__quantum__rt__qubit_release(ptr %[[VAL_6]])
// QIR:         ret void
// QIR:       }
// clang-format on
