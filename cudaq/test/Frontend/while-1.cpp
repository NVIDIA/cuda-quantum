...
// CHECK:             %[[VAL_8:.*]] = cc.cast unsigned %[[VAL_7]] : (i32) -> i64
...
// CHECK:             %[[VAL_12:.*]] = cc.cast unsigned %[[VAL_11]] : (i32) -> i64
...
// CHECK:             %[[VAL_16:.*]] = cc.cast unsigned %[[VAL_15]] : (i32) -> i64
...
// CHECK:             %[[VAL_15:.*]] = cc.cast unsigned %[[VAL_14]] : (i32) -> i64
...
// CHECK:             %[[VAL_19:.*]] = cc.cast unsigned %[[VAL_18]] : (i32) -> i64
