...
steps = numpy.linspace(0, 50, 1001)
schedule = Schedule(steps, ["time"])

evolution_result = evolve(hamiltonian, dimensions, schedule, rho0, observables = [pauli.x(0), pauli.y(0), pauli.z(0)], collapse_operators = c_ops, store_intermediate_results = True)
