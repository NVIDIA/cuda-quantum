...
evolution_result = evolve(hamiltonian, dimensions, schedule, rho0, observables = [pauli.y(0), pauli.z(0)], collapse_operators = [np.sqrt(0.05) * pauli.x(0)], store_intermediate_results = True)
