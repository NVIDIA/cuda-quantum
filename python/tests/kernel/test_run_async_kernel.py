...
def test_simple_run_ghz():
    shots = 100
    qubitCount = 4
    results = cudaq.run_async(simple, qubitCount, shots_count=shots)
    print(results)
...
#     results = cudaq.run_async(simple_tuple_int_float_no_args, shots_count=2).get()
#     assert len(results) == 2
...
#     results = cudaq.run_async(simple_tuple_int_float, 2, (13, 42.3), shots_count=2).get()
#     assert len(results) == 2
#     assert results[0] == (13, 42.3)
#     assert results[1] == (13, 42.3)
...
#     results = cudaq.run_async(simple_tuple_int_float_assign,
#                         2, (13, 42.3),
#                         shots_count=2).get()
#     # assert len(results) == 2
...
#     results = cudaq.run_async(simple_tuple_float_int_no_args, shots_count=2).get()
#     assert len(results) == 2
...
#     results = cudaq.run_async(simple_tuple_float_int, 2, (42.3, 13), shots_count=2).get()
#     assert len(results) == 2
#     assert results[0] == (42.3, 13)
#     assert results[1] == (42.3, 13)
...
#     results = cudaq.run_async(simple_tuple_bool_int_no_args, shots_count=2).get()
#     assert len(results) == 2
...
#     results = cudaq.run_async(simple_tuple_bool_int, 2, (True, 13), shots_count=2).get()
#     assert len(results) == 2
#     assert results[0] == (True, 13)
#     assert results[1] == (True, 13)
...
#     results = cudaq.run_async(simple_tuple_int_bool_no_args, shots_count=2).get()
#     assert len(results) == 2
...
#     results = cudaq.run_async(simple_tuple_int_bool, 2, (-13, True), shots_count=2).get()
#     assert len(results) == 2
#     assert results[0] == (-13, True)
#     assert results[1] == (-13, True)
...
#     # results = cudaq.run_async(simple_tuple_int32_bool_no_args, shots_count=2).get()
#     # assert len(results) == 2
...
#     # results = cudaq.run_async(simple_tuple_int32_bool_no_args1, shots_count=2).get()
#     # assert len(results) == 2
#     # assert results[0] == (np.int32(-13), True)
#     # assert results[1] == (np.int32(-13), True)
...
#     results = cudaq.run_async(simple_tuple_int32_bool,
#                         2, (np.int32(-13), True),
#                         shots_count=2).get()
#     assert len(results) == 2
#     assert results[0] == (-13, True)
...
#     results = cudaq.run_async(simple_tuple_bool_int_float_no_args, shots_count=2).get()
#     assert len(results) == 2
...
#     results = cudaq.run_async(simple_tuple_bool_int_float,
#                         2, (True, 13, 42.3),
#                         shots_count=2).get()
#     assert len(results) == 2
#     assert results[0] == (True, 13, 42.3)
...
#     results = cudaq.run_async(simple_dataclass_int_bool_no_args, shots_count=2).get()
#     assert len(results) == 2
...
#     results = cudaq.run_async(simple_dataclass_bool_int_no_args, shots_count=2).get()
#     assert len(results) == 2
...
#     results = cudaq.run_async(simple_dataclass_float_int_no_args, shots_count=2).get()
#     assert len(results) == 2
...
#     results = cudaq.run_async(simple_struct, MyClass(-13, True), shots_count=2).get()
#     print(results)
#     assert len(results) == 2
...
#     results = cudaq.run_async(kernel, 2, shots_count=1)
#     print(results)
