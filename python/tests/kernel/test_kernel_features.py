...
def test_adjoint():
    ...
    # FIXME: This currently fails because the adjoint function, if it can be
    # autogenerated at all, is not apparently correct. Also, this test appears
    # to be incorrect as well, since one would expect X -> UCCSD -> UCCSD<adj>
    # to still be X and produce all 1s.
