...
# CHECK-DAG:       %[[VAL_5:.*]] = quake.alloca !quake.veq<3>
# CHECK:           %[[VAL_6:.*]] = cc.loop while ((%[[VAL_7:.*]] = %[[VAL_4]]) -> (index)) {
# CHECK:             %[[VAL_8:.*]] = arith.cmpi slt, %[[VAL_7]], %[[VAL_1]] : index
# CHECK:             cc.condition %[[VAL_8]](%[[VAL_7]] : index)
# CHECK:           } do {
# CHECK:           ^bb0(%[[VAL_9:.*]]: index):
# CHECK:             %[[VAL_10:.*]] = quake.extract_ref %[[VAL_5]]{{\[}}%[[VAL_9]]] : (!quake.veq<3>, index) -> !quake.ref
...
# CHECK:           } {invariant}
# CHECK:           %[[VAL_13:.*]] = cc.loop while ((%[[VAL_14:.*]] = %[[VAL_4]]) -> (index)) {
# CHECK:             %[[VAL_15:.*]] = arith.cmpi slt, %[[VAL_14]], %[[VAL_1]] : index
# CHECK:             cc.condition %[[VAL_15]](%[[VAL_14]] : index)
# CHECK:           } do {
# CHECK:           ^bb0(%[[VAL_16:.*]]: index):
# CHECK:             %[[VAL_17:.*]] = quake.extract_ref %[[VAL_5]]{{\[}}%[[VAL_16]]] : (!quake.veq<3>, index) -> !quake.ref
# CHECK:             quake.rx (%[[VAL_2]]) %[[VAL_17]] : (f64, !quake.ref) -> ()
# CHECK:             cc.continue %[[VAL_16]] : index
# CHECK:           } step {
# CHECK:           ^bb0(%[[VAL_18:.*]]: index):
# CHECK:             %[[VAL_19:.*]] = arith.addi %[[VAL_18]], %[[VAL_3]] : index
# CHECK:             cc.continue %[[VAL_19]] : index
# CHECK:           } {invariant}
# CHECK:           %[[VAL_20:.*]] = cc.loop while ((%[[VAL_21:.*]] = %[[VAL_4]]) -> (index)) {
# CHECK:             %[[VAL_22:.*]] = arith.cmpi slt, %[[VAL_21]], %[[VAL_1]] : index
# CHECK:             cc.condition %[[VAL_22]](%[[VAL_21]] : index)
# CHECK:           } do {
# CHECK:           ^bb0(%[[VAL_23:.*]]: index):
# CHECK:             %[[VAL_24:.*]] = quake.extract_ref %[[VAL_5]]{{\[}}%[[VAL_23]]] : (!quake.veq<3>, index) -> !quake.ref
# CHECK:             quake.ry (%[[VAL_0]]) %[[VAL_24]] : (f64, !quake.ref) -> ()
# CHECK:             cc.continue %[[VAL_23]] : index
# CHECK:           } step {
# CHECK:           ^bb0(%[[VAL_25:.*]]: index):
# CHECK:             %[[VAL_26:.*]] = arith.addi %[[VAL_25]], %[[VAL_3]] : index
# CHECK:             cc.continue %[[VAL_26]] : index
# CHECK:           } {invariant}
# CHECK:           %[[VAL_27:.*]] = cc.loop while ((%[[VAL_28:.*]] = %[[VAL_4]]) -> (index)) {
# CHECK:             %[[VAL_29:.*]] = arith.cmpi slt, %[[VAL_28]], %[[VAL_1]] : index
# CHECK:             cc.condition %[[VAL_29]](%[[VAL_28]] : index)
# CHECK:           } do {
# CHECK:           ^bb0(%[[VAL_30:.*]]: index):
# CHECK:             %[[VAL_31:.*]] = quake.extract_ref %[[VAL_5]]{{\[}}%[[VAL_30]]] : (!quake.veq<3>, index) -> !quake.ref
# CHECK:             quake.ry (%[[VAL_2]]) %[[VAL_31]] : (f64, !quake.ref) -> ()
# CHECK:             cc.continue %[[VAL_30]] : index
# CHECK:           } step {
# CHECK:           ^bb0(%[[VAL_32:.*]]: index):
# CHECK:             %[[VAL_33:.*]] = arith.addi %[[VAL_32]], %[[VAL_3]] : index
# CHECK:             cc.continue %[[VAL_33]] : index
# CHECK:           } {invariant}
# CHECK:           %[[VAL_34:.*]] = cc.loop while ((%[[VAL_35:.*]] = %[[VAL_4]]) -> (index)) {
# CHECK:             %[[VAL_36:.*]] = arith.cmpi slt, %[[VAL_35]], %[[VAL_1]] : index
# CHECK:             cc.condition %[[VAL_36]](%[[VAL_35]] : index)
# CHECK:           } do {
# CHECK:           ^bb0(%[[VAL_37:.*]]: index):
# CHECK:             %[[VAL_38:.*]] = quake.extract_ref %[[VAL_5]]{{\[}}%[[VAL_37]]] : (!quake.veq<3>, index) -> !quake.ref
# CHECK:             quake.rz (%[[VAL_0]]) %[[VAL_38]] : (f64, !quake.ref) -> ()
# CHECK:             cc.continue %[[VAL_37]] : index
# CHECK:           } step {
# CHECK:           ^bb0(%[[VAL_39:.*]]: index):
# CHECK:             %[[VAL_40:.*]] = arith.addi %[[VAL_39]], %[[VAL_3]] : index
# CHECK:             cc.continue %[[VAL_40]] : index
# CHECK:           } {invariant}
# CHECK:           %[[VAL_41:.*]] = cc.loop while ((%[[VAL_42:.*]] = %[[VAL_4]]) -> (index)) {
# CHECK:             %[[VAL_43:.*]] = arith.cmpi slt, %[[VAL_42]], %[[VAL_1]] : index
# CHECK:             cc.condition %[[VAL_43]](%[[VAL_42]] : index)
# CHECK:           } do {
# CHECK:           ^bb0(%[[VAL_44:.*]]: index):
# CHECK:             %[[VAL_45:.*]] = quake.extract_ref %[[VAL_5]]{{\[}}%[[VAL_44]]] : (!quake.veq<3>, index) -> !quake.ref
# CHECK:             quake.rz (%[[VAL_2]]) %[[VAL_45]] : (f64, !quake.ref) -> ()
# CHECK:             cc.continue %[[VAL_44]] : index
# CHECK:           } step {
# CHECK:           ^bb0(%[[VAL_46:.*]]: index):
# CHECK:             %[[VAL_47:.*]] = arith.addi %[[VAL_46]], %[[VAL_3]] : index
# CHECK:             cc.continue %[[VAL_47]] : index
# CHECK:           } {invariant}
# CHECK:           %[[VAL_48:.*]] = cc.loop while ((%[[VAL_49:.*]] = %[[VAL_4]]) -> (index)) {
# CHECK:             %[[VAL_50:.*]] = arith.cmpi slt, %[[VAL_49]], %[[VAL_1]] : index
# CHECK:             cc.condition %[[VAL_50]](%[[VAL_49]] : index)
# CHECK:           } do {
# CHECK:           ^bb0(%[[VAL_51:.*]]: index):
# CHECK:             %[[VAL_52:.*]] = quake.extract_ref %[[VAL_5]]{{\[}}%[[VAL_51]]] : (!quake.veq<3>, index) -> !quake.ref
# CHECK:             quake.r1 (%[[VAL_0]]) %[[VAL_52]] : (f64, !quake.ref) -> ()
# CHECK:             cc.continue %[[VAL_51]] : index
# CHECK:           } step {
# CHECK:           ^bb0(%[[VAL_53:.*]]: index):
# CHECK:             %[[VAL_54:.*]] = arith.addi %[[VAL_53]], %[[VAL_3]] : index
# CHECK:             cc.continue %[[VAL_54]] : index
# CHECK:           } {invariant}
# CHECK:           %[[VAL_55:.*]] = cc.loop while ((%[[VAL_56:.*]] = %[[VAL_4]]) -> (index)) {
# CHECK:             %[[VAL_57:.*]] = arith.cmpi slt, %[[VAL_56]], %[[VAL_1]] : index
# CHECK:             cc.condition %[[VAL_57]](%[[VAL_56]] : index)
# CHECK:           } do {
# CHECK:           ^bb0(%[[VAL_58:.*]]: index):
# CHECK:             %[[VAL_59:.*]] = quake.extract_ref %[[VAL_5]]{{\[}}%[[VAL_58]]] : (!quake.veq<3>, index) -> !quake.ref
# CHECK:             quake.r1 (%[[VAL_2]]) %[[VAL_59]] : (f64, !quake.ref) -> ()
# CHECK:             cc.continue %[[VAL_58]] : index
# CHECK:           } step {
# CHECK:           ^bb0(%[[VAL_60:.*]]: index):
# CHECK:             %[[VAL_61:.*]] = arith.addi %[[VAL_60]], %[[VAL_3]] : index
# CHECK:             cc.continue %[[VAL_61]] : index
# CHECK:           } {invariant}
# CHECK:           return
# CHECK:         }
