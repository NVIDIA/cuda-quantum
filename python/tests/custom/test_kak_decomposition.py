...
def test_random_unitary_1():
    ...
    def synth_kernel1():
        ...
        rz(-1.6227831241045358, q[0])
        ry(2.0438479044970648, q[0])
        rz(1.9876644365113276, q[0])

        rz(-2.1357953016157301, q[1])
        rz(1.5016413412274376, q[1])

        h(q[1])
        h(q[0])
        x.ctrl(q[1], q[0])
        rz(1.1436094116691584, q[0])
        x.ctrl(q[0], q[1])
        h(q[1])
        h(q[0])
        ...
        x.ctrl(q[1], q[0])
        rz(0.43621539909016893, q[0])
        x.ctrl(q[0], q[1])
        rx(-1.5707963267948966, q[1])
        rx(-1.5707963267948966, q[0])

        x.ctrl(q[1], q[0])
        rz(-0.13346974688431837, q[0])
        x.ctrl(q[0], q[1])

        rz(-1.3919349692083109, q[0])
        ry(1.3755336786340935, q[0])
        rz(0.38973944841520536, q[0])

        rz(1.0298412539485056, q[1])
        ry(1.3041016705176582, q[1])
        rz(0.44604717417872142, q[1])

        r1(-1.5684876194879964, q[1])
        rz(1.5684876194879964, q[1])
