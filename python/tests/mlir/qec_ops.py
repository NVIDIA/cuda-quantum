...
# CHECK:           %[[LOOP_0:.*]]:5 = cc.loop while ((%[[VAL_2:.*]] = %[[UNDEF_1]], %[[VAL_3:.*]] = %[[UNDEF_0]], %[[VAL_4:.*]] = %[[UNDEF_2]], %[[VAL_5:.*]] = %[[UNDEF_3]], %[[VAL_0:.*]] = %[[CONSTANT_1]]) -> (!cc.measure_handle, !cc.measure_handle, !cc.measure_handle, !cc.measure_handle, i64)) {
# CHECK:             %[[CMPI_0:.*]] = arith.cmpi slt, %[[VAL_0]], %[[ARG0]] : i64
# CHECK:             cc.condition %[[CMPI_0]](%[[VAL_2]], %[[VAL_3]], %[[VAL_4]], %[[VAL_5]], %[[VAL_0]] : !cc.measure_handle, !cc.measure_handle, !cc.measure_handle, !cc.measure_handle, i64)
# CHECK:           } do {
# CHECK:           ^bb0(%[[VAL_8:.*]]: !cc.measure_handle, %[[VAL_9:.*]]: !cc.measure_handle, %[[VAL_10:.*]]: !cc.measure_handle, %[[VAL_11:.*]]: !cc.measure_handle, %[[VAL_6:.*]]: i64):
...
# CHECK:             } else {
# CHECK:             }
# CHECK:             cc.continue %[[MZ_0]], %[[MZ_1]], %[[MZ_0]], %[[MZ_1]], %[[VAL_6]] : !cc.measure_handle, !cc.measure_handle, !cc.measure_handle, !cc.measure_handle, i64
# CHECK:           } step {
# CHECK:           ^bb0(%[[VAL_14:.*]]: !cc.measure_handle, %[[VAL_15:.*]]: !cc.measure_handle, %[[VAL_16:.*]]: !cc.measure_handle, %[[VAL_17:.*]]: !cc.measure_handle, %[[VAL_12:.*]]: i64):
# CHECK:             %[[ADDI_0:.*]] = arith.addi %[[VAL_12]], %[[CONSTANT_0]] : i64
# CHECK:             cc.continue %[[VAL_14]], %[[VAL_15]], %[[VAL_16]], %[[VAL_17]], %[[ADDI_0]] : !cc.measure_handle, !cc.measure_handle, !cc.measure_handle, !cc.measure_handle, i64
# CHECK:           }
