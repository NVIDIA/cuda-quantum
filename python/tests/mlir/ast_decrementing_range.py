...
# CHECK:           cc.store %[[VAL_0]], %[[VAL_15]] : !cc.ptr<i64>
# CHECK:           %[[VAL_16:.*]] = cc.alloca i64
# CHECK:           cc.store %[[VAL_1]], %[[VAL_16]] : !cc.ptr<i64>
# CHECK:           %[[VAL_5:.*]] = quake.alloca !quake.veq<5>
# CHECK:           %[[VAL_17:.*]] = cc.load %[[VAL_15]] : !cc.ptr<i64>
# CHECK:           %[[VAL_18:.*]] = cc.load %[[VAL_16]] : !cc.ptr<i64>
# CHECK:           %[[VAL_8:.*]] = cc.loop while ((%[[VAL_9:.*]] = %[[VAL_17]]) -> (i64)) {
# CHECK:             %[[VAL_10:.*]] = arith.cmpi sgt, %[[VAL_9]], %[[VAL_18]] : i64
# CHECK:             cc.condition %[[VAL_10]](%[[VAL_9]] : i64)
# CHECK:           } do {
# CHECK:           ^bb0(%[[VAL_11:.*]]: i64):
# CHECK:             %[[VAL_3:.*]] = cc.alloca i64
# CHECK:             cc.store %[[VAL_11]], %[[VAL_3]] : !cc.ptr<i64>
# CHECK:             %[[VAL_6:.*]] = cc.load %[[VAL_3]] : !cc.ptr<i64>
# CHECK:             %[[VAL_12:.*]] = quake.extract_ref %[[VAL_5]]{{\[}}%[[VAL_6]]] : (!quake.veq<5>, i64) -> !quake.ref
