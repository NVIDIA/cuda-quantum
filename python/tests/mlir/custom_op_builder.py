...
# CHECK:           return
# CHECK:         }
# CHECK-DAG:     cc.global constant @__nvqpp__mlirgen__foo_0_generator_1.rodata(dense<[{{.*}}]> : tensor<4xcomplex<f64>>) : !cc.array<complex<f64> x 4> {sym_visibility = "private"}
# CHECK-DAG:     cc.global constant @__nvqpp__mlirgen__foo_1_generator_1.rodata(dense<[{{.*}}]> : tensor<4xcomplex<f64>>) : !cc.array<complex<f64> x 4> {sym_visibility = "private"}
# CHECK-DAG:     cc.global constant @__nvqpp__mlirgen__foo_2_generator_1.rodata(dense<[{{.*}}]> : tensor<4xcomplex<f64>>) : !cc.array<complex<f64> x 4> {sym_visibility = "private"}
