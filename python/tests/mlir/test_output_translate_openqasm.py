...
# CHECK-LABEL: // Code generated by NVIDIA's nvq++ compiler
# CHECK: OPENQASM 2.0;
...
# CHECK-NEXT: tdg var0[0];
# CHECK-NEXT: h var0[0];
# CHECK-NEXT: sdg var0[0];
# CHECK-NEXT: cx var0{{\[[12]\]}}, var0[0];
# CHECK-NEXT: tdg var0[0];
# CHECK-NEXT: cx var0{{\[[12]\]}}, var0[0];
# CHECK-NEXT: t var0[0];
...
# CHECK-NEXT: tdg var0{{\[[12]\]}};
# CHECK-NEXT: cx var0{{\[[12]\]}}, var0{{\[[12]\]}};
# CHECK-NEXT: t var0{{\[[12]\]}};
# CHECK-NEXT: t var0{{\[[12]\]}};
# CHECK-NEXT: s var0[0];
# CHECK-NEXT: cx var0{{\[[12]\]}}, var0[0];
...
# CHECK-NEXT: rz(-3.141593e+00) var0[0];
# CHECK-NEXT: h var0[0];
# CHECK-NEXT: creg var4[1];
# CHECK-NEXT: measure var0[0] -> var4[0];
# CHECK-NEXT: sdg var0[0];
# CHECK-NEXT: h var0[0];
# CHECK-NEXT: creg var5[1];
# CHECK-NEXT: measure var0[0] -> var5[0];
# CHECK-NEXT: creg var6[1];
# CHECK-NEXT: measure var0[0] -> var6[0];
