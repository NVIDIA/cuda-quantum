...
# CHECK:           %[[VAL_13:.*]]:2 = cc.loop while ((%[[VAL_14:.*]] = %[[VAL_4]], %[[VAL_16:.*]] = %[[VAL_0]]) -> (i64, f64)) {
# CHECK:             %[[VAL_17:.*]] = arith.cmpi slt, %[[VAL_14]], %[[VAL_5]] : i64
# CHECK:             cc.condition %[[VAL_17]](%[[VAL_14]], %[[VAL_16]] : i64, f64)
# CHECK:           } do {
# CHECK:           ^bb0(%[[VAL_18:.*]]: i64, %[[VAL_20:.*]]: f64):
...
# CHECK:             cc.continue %[[VAL_18]], %[[VAL_24]] : i64, f64
# CHECK:           } step {
# CHECK:           ^bb0(%[[VAL_27:.*]]: i64, %[[VAL_29:.*]]: f64):
# CHECK:             %[[VAL_30:.*]] = arith.addi %[[VAL_27]], %[[VAL_3]] : i64
# CHECK:             cc.continue %[[VAL_30]], %[[VAL_29]] : i64, f64
# CHECK:           }
