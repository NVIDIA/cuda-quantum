...
# CHECK:           %[[VAL_6:.*]]:2 = cc.loop while ((%[[VAL_7:.*]] = %[[VAL_2]], %[[VAL_8:.*]] = %[[VAL_3]]) -> (i64, f64)) {
# CHECK:             %[[VAL_10:.*]] = arith.cmpi slt, %[[VAL_7]], %[[VAL_5]] : i64
# CHECK:             cc.condition %[[VAL_10]](%[[VAL_7]], %[[VAL_8]] : i64, f64)
# CHECK:           } do {
# CHECK:           ^bb0(%[[VAL_11:.*]]: i64, %[[VAL_12:.*]]: f64):
...
# CHECK:             %[[VAL_17:.*]] = quake.extract_ref %[[VAL_4]]{{\[}}%[[VAL_11]]] : (!quake.veq<4>, i64) -> !quake.ref
# CHECK:             quake.ry (%[[VAL_16]]) %[[VAL_17]] : (f64, !quake.ref) -> ()
# CHECK:             cc.continue %[[VAL_11]], %[[VAL_16]] : i64, f64
# CHECK:           } step {
# CHECK:           ^bb0(%[[VAL_19:.*]]: i64, %[[VAL_20:.*]]: f64):
# CHECK:             %[[VAL_22:.*]] = arith.addi %[[VAL_19]], %[[VAL_1]] : i64
# CHECK:             cc.continue %[[VAL_22]], %[[VAL_20]] : i64, f64
# CHECK:           } {normalized}
