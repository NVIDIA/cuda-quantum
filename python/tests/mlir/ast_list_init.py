...
# CHECK:           %[[VAL_15:.*]]:2 = cc.loop while ((%[[VAL_16:.*]] = %[[VAL_1]], %[[VAL_18:.*]] = %[[VAL_7]]) -> (i64, f64)) {
# CHECK:             %[[VAL_19:.*]] = arith.cmpi slt, %[[VAL_16]], %[[VAL_2]] : i64
# CHECK:             cc.condition %[[VAL_19]](%[[VAL_16]], %[[VAL_18]] : i64, f64)
# CHECK:           } do {
# CHECK:           ^bb0(%[[VAL_20:.*]]: i64, %[[VAL_22:.*]]: f64):
...
# CHECK:             cc.continue %[[VAL_20]], %[[VAL_24]] : i64, f64
# CHECK:           } step {
