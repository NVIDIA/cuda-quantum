...
# CHECK:           %[[VAL_9:.*]] = arith.floordivsi %[[VAL_6]], %[[VAL_5]] : i64
...
# CHECK:             %[[VAL_16:.*]] = arith.subi %[[VAL_6]], %[[VAL_13]] : i64
...
# CHECK:           } {invariant}
# CHECK:           %[[VAL_22:.*]] = arith.subi %[[VAL_6]], %[[VAL_3]] : i64
...
# CHECK:               %[[VAL_35:.*]] = arith.subi %[[VAL_28]], %[[VAL_33]] : i64
...
# CHECK:               %[[VAL_39:.*]] = quake.extract_ref %[[VAL_0]]{{\[}}%[[VAL_28]]] : (!quake.veq<?>, i64) -> !quake.ref
...
# CHECK:           } {invariant}
# CHECK:           %[[VAL_46:.*]] = arith.subi %[[VAL_6]], %[[VAL_3]] : i64
