...
# CHECK:           %[[VAL_4:.*]] = cc.stdvec_size %[[VAL_0]] : (!cc.stdvec<f64>) -> i64
# CHECK:           %[[VAL_5:.*]]:2 = cc.loop while ((%[[VAL_6:.*]] = %[[VAL_2]], %[[VAL_7:.*]] = %[[VAL_2]]) -> (i64, i64)) {
# CHECK:             %[[VAL_8:.*]] = arith.cmpi slt, %[[VAL_6]], %[[VAL_4]] : i64
...
# CHECK:             %[[VAL_12:.*]] = cc.compute_ptr %[[VAL_11]]{{\[}}%[[VAL_9]]] : (!cc.ptr<!cc.array<f64 x ?>>, i64) -> !cc.ptr<f64>
# CHECK:             %[[VAL_13:.*]] = cc.load %[[VAL_12]] : !cc.ptr<f64>
# CHECK:             %[[VAL_14:.*]] = quake.extract_ref %[[VAL_3]]{{\[}}%[[VAL_10]]] : (!quake.veq<4>, i64) -> !quake.ref
# CHECK:             quake.ry (%[[VAL_13]]) %[[VAL_14]] : (f64, !quake.ref) -> ()
# CHECK:             %[[VAL_15:.*]] = arith.addi %[[VAL_10]], %[[VAL_1]] : i64
# CHECK:             cc.continue %[[VAL_9]], %[[VAL_15]] : i64, i64
# CHECK:           } step {
