...
conda env config vars set -n cuda-quantum LD_LIBRARY_PATH="$CONDA_PREFIX/envs/cuda-quantum/lib:$CONDA_PREFIX/envs/cuda-quantum/lib/python3.10/site-packages/cuquantum/lib:$CONDA_PREFIX/envs/cuda-quantum/lib/python3.10/site-packages/cutensor/lib:$LD_LIBRARY_PATH"
