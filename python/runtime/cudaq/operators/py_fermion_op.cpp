...
void bindFermionOperator(nb::module_ &mod) {
  ...
  fermion_op_class
      .def(
          "__iter__",
          [](fermion_op &self) {
            return nb::make_iterator(nb::type<fermion_op>(), "iterator",
                                     self.begin(), self.end());
          },
      ...
      .def("__eq__", &fermion_op::operator==, nb::is_operator(),
      ...
      .def(nb::self += scalar_operator(), nb::is_operator())
      .def(nb::self -= scalar_operator(), nb::is_operator())
      .def(nb::self *= fermion_op_term(), nb::is_operator())
      .def(nb::self += fermion_op_term(), nb::is_operator())
      .def(nb::self -= fermion_op_term(), nb::is_operator())
  ...
  fermion_op_term_class
      .def(
          ...
          [](fermion_op_term &self) {
            return nb::make_iterator(nb::type<fermion_op_term>(), "iterator",
                                     self.begin(), self.end());
          },
          nb::keep_alive<0, 1>(), "Loop through each term of the operator.")
      ...
      .def("__eq__", &fermion_op_term::operator==, nb::is_operator(),
           "Return true if the two operators are equivalent. The equivalence "
           "check takes "
           "commutation relations into account. Operators acting on different "
           "degrees of "
      ...
      .def(nb::self + nb::self, nb::is_operator())
      .def(nb::self - nb::self, nb::is_operator())
      .def(nb::self * fermion_op(), nb::is_operator())
      .def(nb::self + fermion_op(), nb::is_operator())
      .def(nb::self - fermion_op(), nb::is_operator())
      .def(nb::self * matrix_op_term(), nb::is_operator())
      .def(nb::self + matrix_op_term(), nb::is_operator())
