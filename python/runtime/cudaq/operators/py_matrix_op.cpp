...
void bindMatrixOperator(py::module &mod) {
  ...
  .def_property_readonly("parameters", &matrix_op::get_parameter_descriptions, 
  ...
  .def("to_matrix", [&cmat_to_numpy, &kwargs_to_param_map](const matrix_op &self,
                                     dimension_map &dimensions,
                                     bool invert_order,
  ...
  .def("__neg__", [](const matrix_op &self) { return -self; }, py::is_operator())
  .def("__pos__", [](const matrix_op &self) { return +self; }, py::is_operator())

  // in-place arithmetics

  .def("__itruediv__", [](matrix_op &self, int other) { return self /= other; }, py::is_operator())
  .def("__imul__", [](matrix_op &self, int other) { return self *= other; }, py::is_operator())
  .def("__iadd__", [](matrix_op &self, int other) { return self += other; }, py::is_operator())
  .def("__isub__", [](matrix_op &self, int other) { return self -= other; }, py::is_operator())
  .def("__itruediv__", [](matrix_op &self, const scalar_operator &other) { return self /= other; }, py::is_operator())
  .def("__imul__", [](matrix_op &self, const scalar_operator &other) { return self *= other; }, py::is_operator())
  .def("__iadd__", [](matrix_op &self, const scalar_operator &other) { return self += other; }, py::is_operator())
  .def("__isub__", [](matrix_op &self, const scalar_operator &other) { return self -= other; }, py::is_operator())
  .def("__imul__", [](matrix_op &self, const matrix_op_term &other) { return self *= other; }, py::is_operator())
  .def("__iadd__", [](matrix_op &self, const matrix_op_term &other) { return self += other; }, py::is_operator())
  .def("__isub__", [](matrix_op &self, const matrix_op_term &other) { return self -= other; }, py::is_operator())
  .def("__imul__", [](matrix_op &self, const matrix_op &other) { return self *= other; }, py::is_operator())
  .def("__iadd__", [](matrix_op &self, const matrix_op &other) { return self += other; }, py::is_operator())
  .def("__isub__", [](matrix_op &self, const matrix_op &other) { return self -= other; }, py::is_operator())

  // right-hand arithmetics

  .def("__truediv__", [](const matrix_op &self, int other) { return self / other; }, py::is_operator())
  .def("__mul__", [](const matrix_op &self, int other) { return self * other; }, py::is_operator())
  .def("__add__", [](const matrix_op &self, int other) { return self + other; }, py::is_operator())
  .def("__sub__", [](const matrix_op &self, int other) { return self - other; }, py::is_operator())
  .def("__truediv__", [](const matrix_op &self, const scalar_operator &other) { return self / other; }, py::is_operator())
  .def("__mul__", [](const matrix_op &self, const scalar_operator &other) { return self * other; }, py::is_operator())
  .def("__add__", [](const matrix_op &self, const scalar_operator &other) { return self + other; }, py::is_operator())
  .def("__sub__", [](const matrix_op &self, const scalar_operator &other) { return self - other; }, py::is_operator())
  .def("__mul__", [](const matrix_op &self, const matrix_op_term &other) { return self * other; }, py::is_operator())
  .def("__add__", [](const matrix_op &self, const matrix_op_term &other) { return self + other; }, py::is_operator())
  .def("__sub__", [](const matrix_op &self, const matrix_op_term &other) { return self - other; }, py::is_operator())
  .def("__mul__", [](const matrix_op &self, const matrix_op &other) { return self * other; }, py::is_operator())
  .def("__add__", [](const matrix_op &self, const matrix_op &other) { return self + other; }, py::is_operator())
  .def("__sub__", [](const matrix_op &self, const matrix_op &other) { return self - other; }, py::is_operator())

  // left-hand arithmetics

  .def("__rmul__", [](const matrix_op &other, int self) { return self * other; }, py::is_operator())
  .def("__radd__", [](const matrix_op &other, int self) { return self + other; }, py::is_operator())
  .def("__rsub__", [](const matrix_op &other, int self) { return self - other; }, py::is_operator())
  .def("__rmul__", [](const matrix_op &other, double self) { return self * other; }, py::is_operator())
  .def("__radd__", [](const matrix_op &other, double self) { return self + other; }, py::is_operator())
  .def("__rsub__", [](const matrix_op &other, double self) { return self - other; }, py::is_operator())
  .def("__rmul__", [](const matrix_op &other, std::complex<double> self) { return self * other; }, py::is_operator())
  .def("__radd__", [](const matrix_op &other, std::complex<double> self) { return self + other; }, py::is_operator())
  .def("__rsub__", [](const matrix_op &other, std::complex<double> self) { return self - other; }, py::is_operator())
  .def("__rmul__", [](const matrix_op &other, const scalar_operator &self) { return self * other; }, py::is_operator())
  .def("__radd__", [](const matrix_op &other, const scalar_operator &self) { return self + other; }, py::is_operator())
  .def("__rsub__", [](const matrix_op &other, const scalar_operator &self) { return self - other; }, py::is_operator())
  ...
  .def("trim", &matrix_op::trim,
    ...
    "the given tolerance.")
  .def("trim", [&kwargs_to_param_map](matrix_op &self, double tol, const py::kwargs &kwargs) {
  ...
  .def_property_readonly("parameters", &matrix_op_term::get_parameter_descriptions,
    "Returns a dictionary that maps each parameter name to its description.")
  ...
  .def_property_readonly("term_id", &matrix_op_term::get_term_id,
  ...
  .def_property_readonly("coefficient", &matrix_op_term::get_coefficient,
  ...
  .def("to_matrix", [&cmat_to_numpy](const matrix_op_term &self,
    ...
    "can be inverted by setting the optional `invert_order` argument to `True`. "
    "See also the documentation for `degrees` for more detail.")
  .def("to_matrix", [&cmat_to_numpy, &kwargs_to_param_map](const matrix_op_term &self,
                                     dimension_map &dimensions,
                                     bool invert_order,
                                     const py::kwargs& kwargs) {
      return cmat_to_numpy(self.to_matrix(dimensions, kwargs_to_param_map(kwargs), invert_order));
  ...
  .def("__neg__", [](const matrix_op_term &self) { return -self; }, py::is_operator())
  .def("__pos__", [](const matrix_op_term &self) { return +self; }, py::is_operator())

  // in-place arithmetics

  .def("__itruediv__", [](matrix_op_term &self, int other) { return self /= other; }, py::is_operator())
  .def("__imul__", [](matrix_op_term &self, int other) { return self *= other; }, py::is_operator())
  .def("__itruediv__", [](matrix_op_term &self, const scalar_operator &other) { return self /= other; }, py::is_operator())
  .def("__imul__", [](matrix_op_term &self, const scalar_operator &other) { return self *= other; }, py::is_operator())
  .def("__imul__", [](matrix_op_term &self, const matrix_op_term &other) { return self *= other; }, py::is_operator())

  // right-hand arithmetics

  .def("__truediv__", [](const matrix_op_term &self, int other) { return self / other; }, py::is_operator())
  .def("__mul__", [](const matrix_op_term &self, int other) { return self * other; }, py::is_operator())
  .def("__add__", [](const matrix_op_term &self, int other) { return self + other; }, py::is_operator())
  .def("__sub__", [](const matrix_op_term &self, int other) { return self - other; }, py::is_operator())
  .def("__truediv__", [](const matrix_op_term &self, const scalar_operator &other) { return self / other; }, py::is_operator())
  .def("__mul__", [](const matrix_op_term &self, const scalar_operator &other) { return self * other; }, py::is_operator())
  .def("__add__", [](const matrix_op_term &self, const scalar_operator &other) { return self + other; }, py::is_operator())
  .def("__sub__", [](const matrix_op_term &self, const scalar_operator &other) { return self - other; }, py::is_operator())
  .def("__mul__", [](const matrix_op_term &self, const matrix_op_term &other) { return self * other; }, py::is_operator())
  .def("__add__", [](const matrix_op_term &self, const matrix_op_term &other) { return self + other; }, py::is_operator())
  .def("__sub__", [](const matrix_op_term &self, const matrix_op_term &other) { return self - other; }, py::is_operator())
  .def("__mul__", [](const matrix_op_term &self, const matrix_op &other) { return self * other; }, py::is_operator())
  .def("__add__", [](const matrix_op_term &self, const matrix_op &other) { return self + other; }, py::is_operator())
  .def("__sub__", [](const matrix_op_term &self, const matrix_op &other) { return self - other; }, py::is_operator())

  // left-hand arithmetics

  .def("__rmul__", [](const matrix_op_term &other, int self) { return self * other; }, py::is_operator())
  .def("__radd__", [](const matrix_op_term &other, int self) { return self + other; }, py::is_operator())
  .def("__rsub__", [](const matrix_op_term &other, int self) { return self - other; }, py::is_operator())
  .def("__rmul__", [](const matrix_op_term &other, double self) { return self * other; }, py::is_operator())
  .def("__radd__", [](const matrix_op_term &other, double self) { return self + other; }, py::is_operator())
  .def("__rsub__", [](const matrix_op_term &other, double self) { return self - other; }, py::is_operator())
  .def("__rmul__", [](const matrix_op_term &other, std::complex<double> self) { return self * other; }, py::is_operator())
  .def("__radd__", [](const matrix_op_term &other, std::complex<double> self) { return self + other; }, py::is_operator())
  .def("__rsub__", [](const matrix_op_term &other, std::complex<double> self) { return self - other; }, py::is_operator())
  .def("__rmul__", [](const matrix_op_term &other, const scalar_operator &self) { return self * other; }, py::is_operator())
  .def("__radd__", [](const matrix_op_term &other, const scalar_operator &self) { return self + other; }, py::is_operator())
  .def("__rsub__", [](const matrix_op_term &other, const scalar_operator &self) { return self - other; }, py::is_operator())
