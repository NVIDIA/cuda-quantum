...
void bindObserveResult(py::module &mod) {
  py::class_<observe_result>(
      ...
      .def(
          ...
          """
          Returns:
          :class:`SampleResult` dictionary with the measurement 
      ...
      .def("counts", &observe_result::counts<spin_op>, py::arg("sub_term"),
            """
            Given a `sub_term` of the global `spin_operator` that was passed 
      ...
      .def(
          ...
          """
          Return the expectation value of the `spin_operator` 
          that was provided in :func:`observe`.
          """
          )
      .def(
          "expectation_z",
          ...
          py::arg("sub_term"),
          """
          Return the expectation value of an individual `sub_term` of the 
  ...
  py::class_<async_observe_result>(
      ...
      """
      A data-type containing the results of a call to :func:`observe_async`. 
      ...
      """
      Returns: 
      class:`ObserveResult` from the asynchronous observe execution.
      """
         )
