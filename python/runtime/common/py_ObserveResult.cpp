...
void bindObserveResult(py::module &mod) {
  py::class_<observe_result>(
    ...
    return self.exp_val_z(); },
          "Return the expectation value of the `spin_operator` that was provided in :func:`observe`.")
      .def(
          "expectation_z",
  ...
  py::class_<async_observe_result>(
    ...
    return f;
      ...
      .def("get", &async_observe_result::get,
        "Returns the class:`ObserveResult` from the asynchronous observe execution.")
