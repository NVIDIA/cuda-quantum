...
from cudaq.kernel.utils import check_no_measure_result_return
...
def run(decorator, *args, shots_count=100, noise_model=None, qpu_id=0):
    check_no_measure_result_return(decorator.kernelFunction if hasattr(
        decorator, 'kernelFunction') else None,
                                   context="run")
