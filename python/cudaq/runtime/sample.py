...
def __broadcastSample(kernel, *args, shots_count=0, explicit_measurements=None):
...
def sample(kernel,
    ...
    Args:
      ...
      *arguments (Optional[Any]): The concrete values to evaluate the kernel
      ...
      explicit_measurements (Optional[bool]): Deprecated compatibility option.
          A value of `None` uses the default sampling semantics, which preserve
