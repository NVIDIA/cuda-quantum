...
def sample(kernel,
    ...
    if ptsbe_options is not None:
        from cudaq.runtime import ptsbe
        return ptsbe.sample(
            kernel,
            *args,
            shots_count=shots_count,
            noise_model=noise_model,
            max_trajectories=ptsbe_options.max_trajectories,
            sampling_strategy=ptsbe_options.sampling_strategy,
            shot_allocation=ptsbe_options.shot_allocation,
            return_execution_data=ptsbe_options.return_execution_data)
