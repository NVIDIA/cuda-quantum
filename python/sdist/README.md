...
`pip install cudaq`. If you have an NVIDIA GPU on your host system, you
...
```console
cuda_version=11.8.0 # set this variable to your preferred version (>=11.8)
...
conda run -n cudaq-env pip install cudaq
