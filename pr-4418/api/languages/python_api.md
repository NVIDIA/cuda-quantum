...
:   Sample the state generated by the provided [`kernel`{.code .docutils
    ...
    :   -   **kernel** ([[`Kernel`{.xref .py .py-class .docutils
        ...
        -   **explicit_measurements**
            ...
            .external}*\]*) -- Deprecated compatibility option. A value
            of [`None`{.code .docutils .literal .notranslate}]{.pre}
            uses the default sampling semantics, which preserve
            measurement order when required.
...
[[cudaq.]{.pre}]{.sig-prename .descclassname}[[sample_async]{.pre}]{.sig-name .descname}[(]{.sig-paren}*[[decorator]{.pre}]{.n}*, *[[\*]{.pre}]{.o}[[args]{.pre}]{.n}*, *[[shots_count]{.pre}]{.n}[[=]{.pre}]{.o}[[1000]{.pre}]{.default_value}*, *[[explicit_measurements]{.pre}]{.n}[[=]{.pre}]{.o}[[None]{.pre}]{.default_value}*, *[[noise_model]{.pre}]{.n}[[=]{.pre}]{.o}[[None]{.pre}]{.default_value}*, *[[qpu_id]{.pre}]{.n}[[=]{.pre}]{.o}[[0]{.pre}]{.default_value}*[)]{.sig-paren}[¶](#cudaq.sample_async "Permalink to this definition"){.headerlink}
