...
-   [Specifications](../index.html){.reference .internal}
    -   [Language Specification](../cudaq.html){.reference .internal}
        ...
        -   [10. Quantum Patterns](#){.current .reference .internal}
            -   [10.1.
                Compute-Action-Uncompute](#compute-action-uncompute){.reference
                .internal}
...
-   [10. ]{.section-number}Common Quantum Programming Patterns
-   

::: {.rst-breadcrumbs-buttons role="navigation" aria-label="Sequential page navigation"}
[[]{.fa .fa-arrow-circle-left aria-hidden="true"}
Previous](dynamic_kernels.html "9. Just-in-Time Kernel Creation"){.btn
.btn-neutral .float-left} [Next []{.fa .fa-arrow-circle-right
aria-hidden="true"}](platform.html "11. Quantum Platform"){.btn
...
::: {#common-quantum-programming-patterns .section}
[10. ]{.section-number}Common Quantum Programming Patterns[¶](#common-quantum-programming-patterns "Permalink to this heading"){.headerlink}
============================================================================================================================================

::: {#compute-action-uncompute .section}
[10.1. ]{.section-number}Compute-Action-Uncompute[¶](#compute-action-uncompute "Permalink to this heading"){.headerlink}
------------------------------------------------------------------------------------------------------------------------

**\[1\]** CUDA-Q specifies syntax and semantics to support the
compute-action-uncompute pattern, [\\(W = U V U \\dagger\\)]{.math
.notranslate .nohighlight} (here [\\(U\\)]{.math .notranslate
.nohighlight} is the compute block, and [\\(V\\)]{.math .notranslate
.nohighlight} is the action block).

**\[2\]** Via special syntax for this pattern CUDA-Q enables compiler
implementations to key on circuit optimizations via programmer intent.
Specifically, controlled versions of [\\(W\\)]{.math .notranslate
.nohighlight} do not produce controlled operations of all instructions
in [\\(U\\)]{.math .notranslate .nohighlight}, [\\(V\\)]{.math
.notranslate .nohighlight}, and [\\(U \\dagger\\)]{.math .notranslate
.nohighlight}, but instead we are free to only control [\\(V\\)]{.math
.notranslate .nohighlight}.

**\[3\]** The CUDA-Q specification requires the following syntax for
this pattern:
...
**\[4\]** Compiler implementations must add the uncompute segment and
optimize on any controlled versions of this block of code.
:::
:::
:::
:::
