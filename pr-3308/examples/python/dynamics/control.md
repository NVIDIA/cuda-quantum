...
::: {.output_area .docutils .container}
![](../../../_images/examples_python_dynamics_control_4_1.png)
:::
:::
:::
...
.literal .notranslate}) being driven close to resonance in the presence
of noise (decoherence) and exhibiting Rabi oscillations.
...
::: {.output_area .docutils .container}
![](../../../_images/examples_python_dynamics_control_6_1.png)
:::
:::
:::
...
::: {.output_area .docutils .container}
![](../../../_images/examples_python_dynamics_control_8_1.png)
:::
:::
:::

::: {#Landau-Zenner .section}
Landau-Zenner[¶](#Landau-Zenner "Permalink to this heading"){.headerlink}
-------------------------------------------------------------------------

This example simulates the so-called Landau--Zener transition: given a
time-dependent Hamiltonian such that the energy separationof the two
states is a linear function of time, an analytical formula exists to
calculate the probability of finding the system in the excited state
...
::: {.output_area .docutils .container}
![](../../../_images/examples_python_dynamics_control_10_1.png)
:::
:::
:::
:::
