...
-   [Basics](../basics/basics.html){.reference .internal}
    ...
    -   [Troubleshooting](../basics/troubleshooting.html){.reference
        ...
        -   [Debugging and Verbose Simulation
            ...
            .internal}
-   [Examples](#){.current .reference .internal}
    ...
    -   [Dynamics Examples](dynamics_examples.html){.reference
        .internal}
        -   [Cavity QED](dynamics_examples.html#cavity-qed){.reference
            .internal}
        -   [Cross
            Resonance](dynamics_examples.html#cross-resonance){.reference
            .internal}
        -   [Gate
            Calibration](dynamics_examples.html#gate-calibration){.reference
            .internal}
        -   [Heisenberg
            Model](dynamics_examples.html#heisenberg-model){.reference
            .internal}
        -   [Ion Trap](dynamics_examples.html#ion-trap){.reference
            .internal}
        -   [Landau
            Zener](dynamics_examples.html#landau-zener){.reference
            .internal}
        -   [Pulse](dynamics_examples.html#pulse){.reference .internal}
        -   [Qubit
            Control](dynamics_examples.html#qubit-control){.reference
            .internal}
        -   [Qubit
            Dynamics](dynamics_examples.html#qubit-dynamics){.reference
            .internal}
        -   [Silicon Spin
            Qubit](dynamics_examples.html#silicon-spin-qubit){.reference
            .internal}
        -   [Tensor
            Callback](dynamics_examples.html#tensor-callback){.reference
            .internal}
        -   [Transmon
            Resonator](dynamics_examples.html#transmon-resonator){.reference
            .internal}
        -   [Initial State (Multi-GPU
            Multi-Node)](dynamics_examples.html#initial-state-multi-gpu-multi-node){.reference
            .internal}
        -   [Heisenberg Model (Multi-GPU
            Multi-Node)](dynamics_examples.html#heisenberg-model-multi-gpu-multi-node){.reference
            .internal}
...
Previous](../basics/troubleshooting.html "Troubleshooting"){.btn
.btn-neutral .float-left} [Next []{.fa .fa-arrow-circle-right
aria-hidden="true"}](introduction.html "Introduction"){.btn .btn-neutral
.float-right}
:::
...
::: {#cuda-q-by-example .section}
CUDA-Q by Example[¶](#cuda-q-by-example "Permalink to this heading"){.headerlink}
=================================================================================

Examples that illustrate how to use CUDA-Q for application development
are available in C++ and Python.

::: {.toctree-wrapper .compound}
-   [Introduction](introduction.html){.reference .internal}
-   [Building Kernels](building_kernels.html){.reference .internal}
-   [Quantum Operations](quantum_operations.html){.reference .internal}
-   [Measuring Kernels](measuring_kernels.html){.reference .internal}
-   [Visualizing
    Kernels](../../examples/python/visualization.html){.reference
    .internal}
-   [Executing Kernels](executing_kernels.html){.reference .internal}
-   [Computing Expectation Values](expectation_values.html){.reference
    .internal}
-   [Multi-GPU Workflows](multi_gpu_workflows.html){.reference
    .internal}
-   [Optimizers &
...
-   [Using Quantum Hardware
    Providers](hardware_providers.html){.reference .internal}
-   [Dynamics Examples](dynamics_examples.html){.reference .internal}
:::
:::
:::
:::
