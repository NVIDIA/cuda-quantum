...
`CUDAQ_LOG_LEVEL`{.code .docutils .literal .notranslate} environment
variable. For any CUDA-Q executable, just prepend this and turn it on:
...
`CUDAQ_DUMP_JIT_IR`{.code .docutils .literal .notranslate} environment
