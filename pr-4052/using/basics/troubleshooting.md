...
-   [Basics](basics.html){.reference .internal}
    ...
    -   [Troubleshooting](#){.current .reference .internal}
...
Previous](run_kernel.html "Running your first CUDA-Q Program"){.btn
.btn-neutral .float-left accesskey="p"} [Next []{.fa
.fa-arrow-circle-right
aria-hidden="true"}](../examples/examples.html "CUDA-Q by Example"){.btn
...
::: {#debugging-and-verbose-simulation-output .section}
## Debugging and Verbose Simulation Output[¶](#debugging-and-verbose-simulation-output "Permalink to this heading"){.headerlink}

One helpful mechanism of debugging CUDA-Q simulation execution is the
[`CUDAQ_LOG_LEVEL`{.code .docutils .literal .notranslate}]{.pre}
environment variable. For any CUDA-Q executable, just prepend this and
turn it on:
...
Similarly, one may write the IR to their console or to a file before
remote submission. This may be done through the
[`CUDAQ_DUMP_JIT_IR`{.code .docutils .literal .notranslate}]{.pre}
environment variable. For any CUDA-Q executable, just prepend as
follows:
