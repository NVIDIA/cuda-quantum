...
applying gate operations. You can learn the quantum circuit
visualization tool below to build some common quantum circuits and the
associated CUDA-Q kernels. Then, you can learn more about the details of
the syntax in the sections below.
