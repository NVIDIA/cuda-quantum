...
-   [Applications](../../using/applications.html){.reference .internal}
    ...
    -   [Multi-reference Quantum Krylov Algorithm - [\\(H_2\\)]{.math
        ...
        -   [Determining the ground state energy of the
            ...
            .internal}
    -   [Quantum-Selected Configuration Interaction (QSCI)](#){.current
        .reference .internal}
        -   [0. Problem definition](#0.-Problem-definition){.reference
            .internal}
        -   [1. Prepare an Approximate Quantum
            State](#1.-Prepare-an-Approximate-Quantum-State){.reference
            .internal}
        -   [2 Quantum Sampling to Select
            Configuration](#2-Quantum-Sampling-to-Select-Configuration){.reference
            .internal}
...
::: {#Quantum-Selected-Configuration-Interaction-(QSCI) .section}
# Quantum-Selected Configuration Interaction (QSCI)[¶](#Quantum-Selected-Configuration-Interaction-(QSCI) "Permalink to this heading"){.headerlink}

Quantum-Selected Configuration Interaction (QSCI) \[1\] is a
quantum-classical hybrid algorithm designed for electronic structure
calculations, particularly to compoute ground state and excited state
energies of molecular systems. This method is one of the quantum
subspace diagonalization (QSD). It is well-suited for NISQ-era quantum
devices, focusing on using quantum resources efficiently while
maintaining high accuracy.

![quantum-subspace-diagonalization](../../_images/qsd.png)

QSCI selects this vector space from a sampled computational basis.

::: {#0.-Problem-definition .section}
## 0. Problem definition[¶](#0.-Problem-definition "Permalink to this heading"){.headerlink}

Let's define Hamiltonian of [\\(\\mathrm{H_4}\\)]{.math .notranslate
.nohighlight}.
...
::: {#1.-Prepare-an-Approximate-Quantum-State .section}
## 1. Prepare an Approximate Quantum State[¶](#1.-Prepare-an-Approximate-Quantum-State "Permalink to this heading"){.headerlink}

Start with a variational ansatz (e.g., from VQE) to approximate the
ground state wavefunction on a quantum computer.
...
::: {#2-Quantum-Sampling-to-Select-Configuration .section}
## 2 Quantum Sampling to Select Configuration[¶](#2-Quantum-Sampling-to-Select-Configuration "Permalink to this heading"){.headerlink}

Measure this quantum state multiple times to obtain bitstrings, which
correspond to Slater determinants (electronic configurations).
...
::: {#3.-Classical-Diagonalization-on-the-Selected-Subspace .section}
## 3. Classical Diagonalization on the Selected Subspace[¶](#3.-Classical-Diagonalization-on-the-Selected-Subspace "Permalink to this heading"){.headerlink}

Construct a truncated Hamiltonian matrix using only the selected
determinants. Diagonalize this matrix classically to obtain improved
energy estimates.
...
::: {#Reference .section}
## Reference[¶](#Reference "Permalink to this heading"){.headerlink}

\[1\] "Quantum-selected configuration interaction: classical
diagonalization of hamiltonians in subspaces selected by quantum
computers" K. Kanno, M. Kohda, R. Imai, S. Koh, K. Mitarai, W. Mizukami,
and Y. O. Nakagawa (2023) arXiv: 2302.11320
:::
:::
:::
:::
