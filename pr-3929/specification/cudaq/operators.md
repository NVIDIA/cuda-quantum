    ...
    -   [Language Specification](../cudaq.html){.reference .internal}
        ...
        -   [4. Quantum Operators](#){.current .reference .internal}
            -   [4.1. [`cudaq::spin_op`{.code .docutils .literal
                .notranslate}]{.pre}](#cudaq-spin-op){.reference
                .internal}
...
## [4.1. ]{.section-number}[`cudaq::spin_op`{.code .docutils .literal .notranslate}]{.pre}[¶](#cudaq-spin-op "Permalink to this heading"){.headerlink}

**\[1\]** CUDA-Q provides a native [`spin_op`{.code .docutils .literal
.notranslate}]{.pre} data type in the [`cudaq`{.code .docutils .literal
.notranslate}]{.pre} namespace for the expression of quantum mechanical
spin operators.

**\[2\]** The [`spin_op`{.code .docutils .literal .notranslate}]{.pre}
provides an abstraction for a general tensor product of Pauli spin
operators, and sums thereof:

::: {.math .notranslate .nohighlight}
\\\[H = \\sum\_{i=0}\^M P_i, P_i = \\prod\_{j=0}\^N \\sigma_j\^a\\\]
:::
...
**\[3\]** The [`spin_op`{.code .docutils .literal .notranslate}]{.pre}
...
**\[5\]** The [`spin_op`{.code .docutils .literal .notranslate}]{.pre}
also provides a mechanism for the expression of circuit synthesis tasks
within quantum kernel code. Specifically, operations that encode
[\\(N\\)]{.math .notranslate .nohighlight}^th^order trotterization of
exponentiated [`spin_op`{.code .docutils .literal .notranslate}]{.pre}
rotations, e.g. [\\(U = \\exp(-i H t)\\)]{.math .notranslate
.nohighlight}, where [\\(H\\)]{.math .notranslate .nohighlight} is the
provided [`spin_op`{.code .docutils .literal .notranslate}]{.pre}.
Currently, H is limited to a single product term.

**\[6\]** The [`spin_op`{.code .docutils .literal .notranslate}]{.pre}
can be created within classical host code and quantum kernel code, and
can also be passed by value to quantum kernel code from host code.
:::
:::
:::
:::
