    ...
    -   [Quantum Hardware (QPUs)](hardware.html){.reference .internal}
        ...
        -   [Quantum Control Systems](hardware/qcontrol.html){.reference
            ...
            -   [Quantum
                ...
                .internal}
    -   [Dynamics Simulation](#){.current .reference .internal}
...
Previous](hardware/qcontrol.html "Quantum Control Systems"){.btn
.btn-neutral .float-left accesskey="p"} [Next []{.fa
.fa-arrow-circle-right
aria-hidden="true"}](cloud.html "CUDA-Q Cloud Backends"){.btn
...
Explore the [[dynamics docs page]{.std
.std-ref}](../dynamics.html#dynamics){.reference .internal} to see
examples and learn more about CUDA-Q's dynamics capabilities.

<figure id="id1" class="align-default">
<a href="../../_images/dynamics.png"
class="reference internal image-reference"><img
src="../../_images/dynamics.png" style="width: 1000px;"
alt="../../_images/dynamics.png" /></a>
<figcaption><p><span class="caption-text">The NVIDIA accelerated
dynamics capabilities enabled Google to perform the largest dynamics
simulations to date with 40 qubits. The results above correspond to a 40
qubit spin chain simulated with 1,024 GPUs.</span><a href="#id1"
class="headerlink"
