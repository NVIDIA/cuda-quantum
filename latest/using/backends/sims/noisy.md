...
+-------------+--------------------+-----------------------------------+
| [`CUDAQ     | positive integer   | The number of state vectors in    |
| _BATCH_SIZE | or [`NONE`{.code   | the batched mode. If              |
| `{.docutils | .docutils .literal | [`NONE`{.code .docutils .literal  |
| .literal    | .n                 | .notranslate}]{.pre}, the batch   |
| .notransl   | otranslate}]{.pre} | size will be calculated based on  |
| ate}]{.pre} |                    | the available device memory.      |
