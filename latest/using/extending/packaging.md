...
-   [Extending](extending.html){.reference .internal}
    ...
    -   [Package & distribute a backend plugin](#){.current .reference
        .internal}
        ...
        -   [Target YAML Reference (Plugin
            ...
            -   [[`%PLUGIN_ROOT%`{.docutils .literal
                .notranslate}]{.pre}](#plugin-root){.reference
                .internal}
            -   [[`target-arguments`{.docutils .literal
                .notranslate}]{.pre}](#target-arguments){.reference
                .internal}
        ...
        -   [Python Packaging](#python-packaging){.reference .internal}
            ...
            -   [[`__init__.py`{.docutils .literal
                .notranslate}]{.pre}](#init-py){.reference .internal}
            -   [[`__main__.py`{.docutils .literal .notranslate}]{.pre}
                ([`--install-nvqpp`{.docutils .literal
                .notranslate}]{.pre}
                hook)](#main-py-install-nvqpp-hook){.reference
                .internal}
        -   [Installing the Plugin for End
            Users](#installing-the-plugin-for-end-users){.reference
            .internal}
            -   [[`pip`{.docutils .literal
                .notranslate}]{.pre}` `{.docutils .literal
                .notranslate}[`install`{.docutils .literal
                .notranslate}]{.pre} (Python --- zero
                config)](#pip-install-python-zero-config){.reference
                .internal}
            -   [[`--install-nvqpp`{.docutils .literal
                .notranslate}]{.pre} (make visible to [`nvq++`{.docutils
                .literal
                .notranslate}]{.pre})](#install-nvqpp-make-visible-to-nvq){.reference
                .internal}
            -   [[`cudaq-install-plugin`{.docutils .literal
                .notranslate}]{.pre} (C++-only
                workflows)](#cudaq-install-plugin-c-only-workflows){.reference
                .internal}
        -   [Discovery Mechanics](#discovery-mechanics){.reference
            .internal}
            -   [[`nvq++`{.docutils .literal .notranslate}]{.pre} target
                resolution](#nvq-target-resolution){.reference
                .internal}
            -   [Python target
                resolution](#python-target-resolution){.reference
                .internal}
            -   [Environment
                variables](#environment-variables){.reference .internal}
        -   [Reference Plugins](#reference-plugins){.reference
            .internal}
        -   [Quick-Start Checklist](#quick-start-checklist){.reference
            .internal}
...
::: {#package-distribute-a-backend-plugin .section}
# Package & Distribute a Backend Plugin[¶](#package-distribute-a-backend-plugin "Permalink to this heading"){.headerlink}

This guide covers how to package a CUDA-Q backend implementation as an
installable Python package, distribute it to end users of the target,
and make it discoverable by both the Python runtime and
[`nvq++`{.docutils .literal .notranslate}]{.pre} after they install it.
For how to *implement* a backend ([`ServerHelper`{.docutils .literal
.notranslate}]{.pre} or [`QPU`{.docutils .literal .notranslate}]{.pre}
subclass), see [[Extending CUDA-Q with a new Hardware
Backend]{.doc}](backend.html){.reference .internal}.

::: {#plugin-package-layout .section}
## Plugin Package Layout[¶](#plugin-package-layout "Permalink to this heading"){.headerlink}
...
The [`targets/`{.docutils .literal .notranslate}]{.pre} and
...
### [`target-arguments`{.docutils .literal .notranslate}]{.pre}[¶](#target-arguments "Permalink to this heading"){.headerlink}

Declares per-target parameters that surface as CLI flags for
[`nvq++`{.docutils .literal .notranslate}]{.pre} and keyword arguments
for [`cudaq.set_target()`{.docutils .literal .notranslate}]{.pre}:
...
These appear as [`--my-backend-api-key`{.docutils .literal
.notranslate}]{.pre}` `{.docutils .literal
.notranslate}[`<value>`{.docutils .literal .notranslate}]{.pre} on the
command line and [`cudaq.set_target("my-backend",`{.docutils .literal
.notranslate}]{.pre}` `{.docutils .literal
.notranslate}[`api_key=...)`{.docutils .literal .notranslate}]{.pre} in
Python.
:::
:::

::: {#building-with-cudaq-external-projects .section}
## Building with [`CUDAQ_EXTERNAL_PROJECTS`{.docutils .literal .notranslate}]{.pre}[¶](#building-with-cudaq-external-projects "Permalink to this heading"){.headerlink}

During development, build your plugin inside the CUDA-Q source tree
without modifying any in-tree files:
...
The plugin output lands in [`build/external/my-backend/`{.docutils
.literal .notranslate}]{.pre} with the standard [`targets/`{.docutils
.literal .notranslate}]{.pre}, [`lib/`{.docutils .literal
.notranslate}]{.pre}, and packaging files ready to use.
...
## Python Packaging[¶](#python-packaging "Permalink to this heading"){.headerlink}

A plugin ships as a standard Python package with a
[`cudaq.backends`{.docutils .literal .notranslate}]{.pre} entry point
...
package for each operating system and architecture required by their
users. When distributing wheels, ensure that each wheel has the platform
tag matching the platform targeted by its shared library; do not
distribute the package as a platform-agnostic wheel.

::: {#pyproject-toml .section}
### [`pyproject.toml`{.docutils .literal .notranslate}]{.pre}[¶](#pyproject-toml "Permalink to this heading"){.headerlink}

::: {.highlight-toml .notranslate}
::: highlight
    [build-system]
...
[`[project.entry-points."cudaq.backends"]`{.docutils .literal
.notranslate}]{.pre} section. The key ([`my-backend`{.docutils .literal
.notranslate}]{.pre}) is a free-form identifier; the value points to the
[`register()`{.docutils .literal .notranslate}]{.pre} function in your
package.
:::

::: {#init-py .section}
### [`__init__.py`{.docutils .literal .notranslate}]{.pre}[¶](#init-py "Permalink to this heading"){.headerlink}
...
When [`import`{.docutils .literal .notranslate}]{.pre}` `{.docutils
.literal .notranslate}[`cudaq`{.docutils .literal .notranslate}]{.pre}
runs, it discovers all [`cudaq.backends`{.docutils .literal
.notranslate}]{.pre} entry points and calls each one. Your
...
::: {#main-py-install-nvqpp-hook .section}
### [`__main__.py`{.docutils .literal .notranslate}]{.pre} ([`--install-nvqpp`{.docutils .literal .notranslate}]{.pre} hook)[¶](#main-py-install-nvqpp-hook "Permalink to this heading"){.headerlink}
...
This lets users run [`python`{.docutils .literal
.notranslate}]{.pre}` `{.docutils .literal .notranslate}[`-m`{.docutils
.literal .notranslate}]{.pre}` `{.docutils .literal
.notranslate}[`my_backend_cudaq`{.docutils .literal
.notranslate}]{.pre}` `{.docutils .literal
.notranslate}[`--install-nvqpp`{.docutils .literal .notranslate}]{.pre}
to symlink the installed package into the [`nvq++`{.docutils .literal
.notranslate}]{.pre} user plugin scope.
:::
:::

::: {#installing-the-plugin-for-end-users .section}
## Installing the Plugin for End Users[¶](#installing-the-plugin-for-end-users "Permalink to this heading"){.headerlink}

In this section, "installation" means installation by an end user who
wants to use the target. It is separate from the preceding build and
packaging steps performed by the plugin author. The steps an end user
follows depend on how the plugin is distributed and whether they access
the target from Python or C++:

::: {#pip-install-python-zero-config .section}
### [`pip`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`install`{.docutils .literal .notranslate}]{.pre} (Python --- zero config)[¶](#pip-install-python-zero-config "Permalink to this heading"){.headerlink}
...
This installs the Python package previously published or otherwise
distributed by the plugin author. After installation in the end user's
Python environment, [`import`{.docutils .literal
.notranslate}]{.pre}` `{.docutils .literal
.notranslate}[`cudaq`{.docutils .literal .notranslate}]{.pre} discovers
the entry point automatically. No further configuration is needed ---
[`cudaq.set_target("my-backend")`{.docutils .literal
.notranslate}]{.pre} works immediately.
:::

::: {#install-nvqpp-make-visible-to-nvq .section}
### [`--install-nvqpp`{.docutils .literal .notranslate}]{.pre} (make visible to [`nvq++`{.docutils .literal .notranslate}]{.pre})[¶](#install-nvqpp-make-visible-to-nvq "Permalink to this heading"){.headerlink}

The Python entry-point mechanism only fires inside a Python process. To
make the Python package that the end user installed above visible to the
[`nvq++`{.docutils .literal .notranslate}]{.pre} compiler driver as
well:
...
This symlinks the installed package directory into the user plugin
scope. After this, [`nvq++`{.docutils .literal
.notranslate}]{.pre}` `{.docutils .literal
.notranslate}[`--target=my-backend`{.docutils .literal
.notranslate}]{.pre} resolves the target.
:::

::: {#cudaq-install-plugin-c-only-workflows .section}
### [`cudaq-install-plugin`{.docutils .literal .notranslate}]{.pre} (C++-only workflows)[¶](#cudaq-install-plugin-c-only-workflows "Permalink to this heading"){.headerlink}
...
::: {#discovery-mechanics .section}
## Discovery Mechanics[¶](#discovery-mechanics "Permalink to this heading"){.headerlink}

::: {#nvq-target-resolution .section}
### [`nvq++`{.docutils .literal .notranslate}]{.pre} target resolution[¶](#nvq-target-resolution "Permalink to this heading"){.headerlink}
...
.literal .notranslate}]{.pre} directory to the linker search path
([`-L`{.docutils .literal .notranslate}]{.pre}) and runtime path
([`-Wl,-rpath`{.docutils .literal .notranslate}]{.pre}).
:::

::: {#python-target-resolution .section}
### Python target resolution[¶](#python-target-resolution "Permalink to this heading"){.headerlink}

At [`import`{.docutils .literal .notranslate}]{.pre}` `{.docutils
.literal .notranslate}[`cudaq`{.docutils .literal .notranslate}]{.pre},
the runtime:
...
After this, [`cudaq.set_target("my-backend")`{.docutils .literal
.notranslate}]{.pre} works for any registered target.
:::

::: {#environment-variables .section}
### Environment variables[¶](#environment-variables "Permalink to this heading"){.headerlink}

  Variable                                                       Purpose
  -------------------------------------------------------------- -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  [`CUDAQ_PLUGIN_ROOT`{.docutils .literal .notranslate}]{.pre}   Overrides the user-scope plugin directory for [`nvq++`{.docutils .literal .notranslate}]{.pre} and [`cudaq-install-plugin`{.docutils .literal .notranslate}]{.pre}. Useful for CI, sandboxed builds, or shared filesystems.
  [`XDG_DATA_HOME`{.docutils .literal .notranslate}]{.pre}       Standard XDG variable. When [`CUDAQ_PLUGIN_ROOT`{.docutils .literal .notranslate}]{.pre} is unset, the user scope defaults to [`${XDG_DATA_HOME}/cudaq/plugins`{.docutils .literal .notranslate}]{.pre}.
:::
:::

::: {#reference-plugins .section}
## Reference Plugins[¶](#reference-plugins "Permalink to this heading"){.headerlink}

CUDA-Q ships a reference plugin under
[`docs/sphinx/examples/plugins/`{.docutils .literal .notranslate}]{.pre}
that demonstrates the full plugin lifecycle:

  Plugin                                                                                                                       Shape   What it demonstrates
  ---------------------------------------------------------------------------------------------------------------------------- ------- ---------------------------------------------------------------------------------------------------------------------------------------------------
  [mock_rest](https://github.com/NVIDIA/cuda-quantum/tree/main/docs/sphinx/examples/plugins/mock_rest){.reference .external}   REST    [`ServerHelper`{.docutils .literal .notranslate}]{.pre} subclass, [`remote_rest`{.docutils .literal .notranslate}]{.pre} QPU, mock server testing
...
## Quick-Start Checklist[¶](#quick-start-checklist "Permalink to this heading"){.headerlink}
