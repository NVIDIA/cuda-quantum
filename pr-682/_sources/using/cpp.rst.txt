...
.. literalinclude:: ../examples/cpp/basics/static_kernel.cq
    :language: cpp
...
.. literalinclude:: ../examples/cpp/basics/expectation_values.cq
    :language: cpp
...
.. code:: bash 
    ...
    nvq++ expectation_values.cq -o exp_vals.x 
    ./exp_vals.x 
...
.. literalinclude:: ../examples/cpp/basics/multi_controlled_operations.cq
    :language: cpp
...
.. code:: bash 
    ...
    nvq++ multi_controlled_operations.cq -o mcx.x
    ./mcx.x
...
.. literalinclude:: ../examples/cpp/basics/cuquantum_backends.cq
    :language: cpp
...
.. code:: bash 
    ...
    nvq++ --target nvidia cuquantum_backends.cq -o ghz.x
    ./ghz.x
...
.. literalinclude:: ../examples/cpp/providers/quantinuum.cq
    :language: cpp

The following code illustrates how run kernels on IonQ's backends.

.. literalinclude:: ../examples/cpp/providers/ionq.cq
    :language: cpp
