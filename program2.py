...
def test_uccsd():
    ...
    repro_num_qubits = 4
    # should be 3 thetas
    #repro_thetas = [-0.00037043841404585794, 0.0003811110195084151, 0.2286823796532558,-0.00037043841404585794, 0.0003811110195084151, 0.2286823796532558,-0.00037043841404585794, 0.0003811110195084151, 0.2286823796532558]
    repro_thetas = [-.2, -.2, -.2]
    ...
    # repro_kernel.apply_call(repro_trial_state, repro_qubits, repro_num_electrons, repro_thetas)
    # repro_meas = cudaq.sample(repro_kernel, shots_count=1000)
    # print(repro_meas)
