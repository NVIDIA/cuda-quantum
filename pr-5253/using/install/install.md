    ...
    -   [Local Installation](local_installation.html){.reference
        ...
        -   [Dependencies and
            ...
            -   [Dynamic linking to GMP and
                MPFR](local_installation.html#dynamic-linking-to-gmp-and-mpfr){.reference
                .internal}
...
::: {#install-cuda-quantum .toctree-wrapper .compound}
[Contents]{.caption-text}

-   [Local Installation](local_installation.html){.reference .internal}
-   [Data Center Installation](data_center_install.html){.reference
    .internal}
:::
:::
