...
-   [Examples](../../using/examples/examples.html){.reference .internal}
    ...
    -   [Measuring
        ...
        -   [Mid-circuit Measurement and Conditional
            ...
            .internal}
    -   [Visualizing Kernels](../python/visualization.html){.reference
        .internal}
        -   [Qubit
    ...
    -   [Optimizers &
        ...
        -   [3. Parallel Parameter Shift
            ...
            .internal}
    -   [Noisy Simulations](../python/noisy_simulations.html){.reference
        .internal}
...
::: {#cuda-q-example-plugins .section}
# CUDA-Q Example Plugins[¶](#cuda-q-example-plugins "Permalink to this heading"){.headerlink}

This directory contains example external plugins that demonstrate how to
extend CUDA-Q without modifying the core source tree. Each plugin is a
standalone external project with its own documentation, build
instructions, and tests.

  Plugin                                                                                                                  Shape   What it demonstrates
  ----------------------------------------------------------------------------------------------------------------------- ------- ----------------------------------------------------------------------------------------------------------------------------------------------
  [[[`mock_rest/`{.docutils .literal .notranslate}]{.pre}]{.std .std-doc}](mock_rest/README.html){.reference .internal}   REST    [`ServerHelper`{.docutils .literal .notranslate}]{.pre} subclass for the built-in [`remote_rest`{.docutils .literal .notranslate}]{.pre} QPU

See each plugin's README for its design, prerequisites, build and test
commands, installation steps, and runnable examples.
:::
:::
:::
