...
-   [Applications](../../using/applications.html){.reference .internal}
    ...
    -   [Divisive Clustering With Coresets Using
        ...
        -   [Scaling simulations with
            ...
            .internal}
    -   [Hybrid Quantum Neural Networks](#){.current .reference
        .internal}
...
Previous](divisive_clustering_coresets.html "Divisive Clustering With Coresets Using CUDA-Q"){.btn
...
::: {#Hybrid-Quantum-Neural-Networks .section}
# Hybrid Quantum Neural Networks[¶](#Hybrid-Quantum-Neural-Networks "Permalink to this heading"){.headerlink}

The example below highlights a hybrid quantum neural network workflow
with CUDA-Q and PyTorch where both layers can GPU accelerated to
maximise performance.

![hybrid](../../_images/hybrid.png){.no-scaled-link
style="width: 600px;"}

We perform binary classification on the MNIST dataset where data flows
...
![](../../_images/applications_python_hybrid_quantum_neural_networks_9_0.png)
:::
:::
...
::: {.output_area .docutils .container}
![](../../_images/applications_python_hybrid_quantum_neural_networks_15_0.png)
:::
:::
