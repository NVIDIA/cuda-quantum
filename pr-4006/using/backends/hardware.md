    ...
    -   [Circuit Simulation](simulators.html){.reference .internal}
        ...
        -   [Photonics Simulators](sims/photonics.html){.reference
            ...
            -   [orca-photonics](sims/photonics.html#orca-photonics){.reference
                .internal}
    -   [Quantum Hardware (QPUs)](#){.current .reference .internal}
...
Previous](sims/photonics.html "Photonics Simulators"){.btn .btn-neutral
.float-left accesskey="p"} [Next []{.fa .fa-arrow-circle-right
aria-hidden="true"}](hardware/iontrap.html "Ion Trap"){.btn .btn-neutral
...
::: {#quantum-hardware-qpu .section}
# Quantum Hardware (QPU)[¶](#quantum-hardware-qpu "Permalink to this heading"){.headerlink}

CUDA-Q supports submission to a set of hardware providers. To submit to
a hardware backend, you need an account with the respective provider.

<figure class="align-center">
<a href="../../_images/qpus.png"
class="reference internal image-reference"><img
src="../../_images/qpus.png" style="width: 1000px;"
alt="../../_images/qpus.png" /></a>
</figure>
...
-   [Superconducting QPUs](hardware/superconducting.html){.reference
    ...
    -   [Anyon Technologies/Anyon
        Computing](hardware/superconducting.html#anyon-technologies-anyon-computing){.reference
        .internal}
    -   [IQM](hardware/superconducting.html#iqm){.reference .internal}
    -   [OQC](hardware/superconducting.html#oqc){.reference .internal}
    -   [Quantum Circuits,
        Inc.](hardware/superconducting.html#quantum-circuits-inc){.reference
        .internal}
-   [Neutral Atom QPUs](hardware/neutralatom.html){.reference .internal}
    -   [Infleqtion](hardware/neutralatom.html#infleqtion){.reference
        .internal}
    -   [Pasqal](hardware/neutralatom.html#pasqal){.reference .internal}
    -   [QuEra
        Computing](hardware/neutralatom.html#quera-computing){.reference
        .internal}
