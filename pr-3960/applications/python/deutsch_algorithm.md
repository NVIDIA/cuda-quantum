...
If you step through the [`if`{.docutils .literal .notranslate}]{.pre}
statements above, you may notice that we require 2 calls to the function
to determine its property. That is, we have to query [\\(f\\)]{.math
...
![c0892922740f448ea90890c9cd04f6c0](../../_images/oracle.png){.no-scaled-link
...
Above you see an oracle represented as [\\(U_f\\)]{.math .notranslate
.nohighlight} which allows us to transform the state
[\\(\\ket{x}\\ket{y}\\)]{.math .notranslate .nohighlight} into:

::: {.math .notranslate .nohighlight}
\\\[\\begin{aligned} U_f\\ket{x}\\ket{y} = \\ket{x}\\ket{y \\oplus f(x)}
\\end{aligned}\\\]
:::

If [\\(y = 0\\)]{.math .notranslate .nohighlight}, then
[\\(U_f\\ket{x}\\ket{y} = U_f\\ket{x}\\ket{0} = \\ket{x}\\ket{0 \\oplus
f(x)} = \\ket{x}\\ket{f(x)}\\)]{.math .notranslate .nohighlight}, since
[\\(f(x)\\)]{.math .notranslate .nohighlight} can either be
...
::: {.math .notranslate .nohighlight}
\\\[\\begin{split}\\begin{aligned} U_f\\ket{x}\\ket{-} &= U_f \\ket{x}
...
\\ket{x}\\ket{-} & f(x) = 0 \\\\ \\tfrac{1}{\\sqrt{2}}
(\\ket{x}\\ket{1} - \\ket{x}\\ket{0}) = -\\ket{x}\\ket{-} & f(x) = 1
\\\\ \\end{cases} \\\\ &= (-1)\^{f(x)}\\ket{x}\\ket{-}
\\end{aligned}\\end{split}\\\]
:::

In summary, [\\(U_f\\ket{x}\\ket{-} =
...
::: {.math .notranslate .nohighlight}
\\\[\\begin{split}\\begin{aligned} U_f\\ket{+}\\ket{0} &= U_f
\\tfrac{1}{\\sqrt{2}}(\\ket{0}+\\ket{1}) \\ket{0} \\\\ &= U_f
\\tfrac{1}{\\sqrt{2}}(\\ket{0}\\ket{0}+\\ket{1}\\ket{0}) \\\\ &=
\\tfrac{1}{\\sqrt{2}}(U_f \\ket{0}\\ket{0} + U_f \\ket{1}\\ket{0}) \\\\
&= \\tfrac{1}{\\sqrt{2}}(U_f \\ket{0}\\ket{0} + U_f \\ket{1}\\ket{0})
\\\\ &= \\tfrac{1}{\\sqrt{2}}(\\ket{0}\\ket{0 \\oplus f(0)} +
...
![2739b042db3c4fccb66479aa243f01a2](../../_images/deutsch.png){.no-scaled-link
...
::: {.math .notranslate .nohighlight}
\\\[\\ket{\\psi_1} = H_1H_0\\ket{\\psi_0} = H_1H_0\\ket{01} = \\ket{+-}
= \\frac{1}{\\sqrt{2}} (\\ket{0}+\\ket{1})\\ket{-} \\tag{2}\\\]
:::

::: {.math .notranslate .nohighlight}
\\\[\\ket{\\psi_2} = U_f\\ket{\\psi_1} = \\frac{1}{\\sqrt{2}}
(U_f\\ket{0}\\ket{-} + U_f\\ket{1}\\ket{-}) \\tag{3}\\\]
:::

using [\\(U_f\\ket{x}\\ket{-} = (-1)\^{f(x)}\\ket{x}\\ket{-}\\)]{.math
.notranslate .nohighlight} which we proved in the phase oracle section
above:

::: {.math .notranslate .nohighlight}
\\\[\\begin{split}\\begin{aligned} \\ket{\\psi_2} = \\frac{1}{\\sqrt{2}}
((-1)\^{f(0)}\\ket{0}\\ket{-} + (-1)\^{f(1)}\\ket{1}\\ket{-}) \\\\ =
\\frac{1}{\\sqrt{2}} ((-1)\^{f(0)}\\ket{0} + (-1)\^{f(1)}\\ket{1})
\\ket{-} \\\\ \\end{aligned}\\end{split}\\\]
:::
...
[\\(f(b_0,b_1) = \\max(b_0,b_1)\\)]{.math .notranslate .nohighlight} is
neither balanced, nor constant.
