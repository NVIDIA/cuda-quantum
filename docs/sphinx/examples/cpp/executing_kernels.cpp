...
auto hamiltonian = cudaq::spin::z(0) + cudaq::spin::y(1) + cudaq::spin::x(0) * cudaq::spin::z(0);
...
auto hamiltonian_1 = cudaq::spin::x(0) + cudaq::spin::y(1) + cudaq::spin::z(0) * cudaq::spin::y(1);
