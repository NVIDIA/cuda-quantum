...
int main() {
...

  {
    ...
    std::vector<std::complex<double>> init_state;
    ...
    // the init_state vector to a vector with 2 complex values (1 qubit) and get
    // the results.
    ...
    // qubits). Let's rerun the kernel with the new init state.
