...
.. math::
    ...
    \begin{matrix}
    \text{Index} & \text{Basis state } |q_0 q_1\rangle \\
    0 = \textcolor{red}{0}*2^0 + \textcolor{blue}{0}*2^1 & |\textcolor{red}{0}\textcolor{blue}{0}\rangle \\
    1 = \textcolor{red}{1}*2^0 + \textcolor{blue}{0}*2^1 & |\textcolor{red}{1}\textcolor{blue}{0}\rangle \\
    2 = \textcolor{red}{0}*2^0 + \textcolor{blue}{1}*2^1 & |\textcolor{red}{0}\textcolor{blue}{1}\rangle \\
    3 = \textcolor{red}{1}*2^0 + \textcolor{blue}{1}*2^1 & |\textcolor{red}{1}\textcolor{blue}{1}\rangle
    \end{matrix}
...
.. note::
    ...
    :class:`SampleResult`, or in the Pauli word returned by
    ``SpinOperatorTerm.get_pauli_word()``) and contributes :math:`2^0` to
    the statevector index. For example, ``spin.z(0) * spin.i(1) * spin.i(2)``
    has Pauli word ``"ZII"``, with the left-most ``Z`` acting on qubit 0.
    Writing the statevector index as a plain binary number places qubit 0
    on the right, however, because it is the least significant bit: index
    ``1`` in a 3-qubit system is ``001`` in binary but corresponds to the
    basis state :math:`|q_0 q_1 q_2\rangle = |100\rangle`.
