...
The provided networking layer leverages the `Holoscan Sensor Bridge <https://www.nvidia.com/en-us/technologies/holoscan-sensor-bridge/>`_ to handle high-bandwidth data transfer over Ethernet using the RoCEv2 protocol. This layer can optionally be replaced with a custom implementation. 
