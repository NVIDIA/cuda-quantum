...
If an NVIDIA GPU and CUDA runtime libraries are available, the default target is set to `nvidia`. This will utilize the cuQuantum single-GPU simulator. :ref:`cuQuantum single-GPU` 
