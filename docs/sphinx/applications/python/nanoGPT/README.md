...
Because the code is so simple, it is very easy to hack to your needs, train new
...
It is a good idea to benchmark your interconnect (e.g. `iperf3`). In particular
...
This will load the config parameter overrides in
